!(function (t) {
     ...
     t.extend(t.easing, {
          def: "easeOutQuad",
          swing: function (e, i, o, n, a) {
               return t.easing[t.easing.def](e, i, o, n, a);
          },
     ...
     var e,
          ...
          c = {
               ...
               minipopup: {
                    ...
                    space: 20,
                    template:
                         '<div class="minipopup-box"><div class="product"><figure class="product-media"><a href="{{imageLink}}"><img src="{{imageSrc}}" alt="product" width="60" height="60"></a></figure><div class="product-detail"><a href="{{nameLink}}" class="product-name">{{name}}</a><p>has been added to your cart.</p></div></div><div class="product-action"><a href="cart.html" class="btn viewcart">View Cart</a><a href="checkout.html" class="btn btn-dark checkout">Checkout</a></div><button class="mfp-close"></button></div>',
               },
               init: function () {
                    this.initialised ||
                         ((this.initialised = !0),
                    ...
                    t(function () {
                         t("body")
                              ...
                              .each(function () {
                                   var e,
                                        i = t(this),
                                        o = i.data("plugin-options");
                                   if ((o && (e = o), "string" == typeof e))
                                        try {
               ...
               countDown: function () {
                    t(".product-countdown").each(function () {
                         var e = t(this),
                              i = e.data("until"),
                              o = e.data("compact"),
               ...
               appearAnimate: function () {
                    if (t.fn.appear) {
                         ...
                         t('.owl-item [data-animation-name="splitRight"]').each(function () {
                              ...
                              t(".appear-animate").each(function () {
                                   t(this).hasClass("animated") ||
                                        t(this).appear(
                                             function () {
                                                  ...
                                                  if (
                                                       !(
                                                            i.closest(".owl-carousel.slide-animate")
                                                                 .length > 0 &&
                                                            0 ===
                                                                 i.closest(".owl-item.active")
                                                                      .length
                                                       )
                                                  ) {
                                                       var o, n, a;
                                                       (o = i.data("animation-name")
                                                            ? i.data("animation-name")
                                                            : "fadeIn"),
                                                            (a = i.data("animation-duration")
                              ...
                              t(".owl-carousel.slide-animate").each(function () {
                                   ...
                                   t(this).on("translate.owl.carousel", function (e) {
                                        ...
                                        t(this).on("translated.owl.carousel", function (o) {
                                             var n = t(this);
                                             ...
                                             n.find(".owl-item.active .appear-animate").each(
                                                  function () {
                                                       var i,
                                                            o,
                                                            n,
                                                            a = t(this);
                                                       (i = a.data("animation-name")
                                                            ? a.data("animation-name")
                                                            : "fadeIn"),
                                                            (n = a.data("animation-duration")
                                                                 ? a.data("animation-duration")
                                                                 : "1000"),
                                                            (o = a.data("animation-delay")
                                                                 ? a.data("animation-delay")
                                                                 : "0"),
                                                            a.addClass(i),
                                                            "splitRight" != i &&
                                                                 (a.css("animationDelay", o + "ms"),
                                                                 a.css(
                                                                      "animationDuration",
                                                                      n + "ms",
                                                                 )),
               ...
               initProductsScrollLoad: function (e) {
                    var i,
                         o = t(e),
                         n = function (e) {
                              window.pageYOffset > i + o.outerHeight() - window.innerHeight - 150 &&
                                   "loading" != o.data("load-state") &&
                                   t.ajax({
                                        url: "ajax/category-ajax-products.html",
                                        success: function (e) {
                                             var i = t(e);
                                             o.data("load-state", "loading"),
                                                  o.next().hasClass("bounce-loader") ||
                                                       t(
                                                  ...
                                                  setTimeout(function () {
                                                       o.append(i),
                                                            ...
                                                            o.data("load-state", "loaded"),
                                                            a >= 2 &&
                                                                 o.next().css("display", "none");
                                                  }, 1500);
                                             var a = parseInt(
                                                  o.data("load-count") ? o.data("load-count") : 0,
                                             );
                                             o.data("load-count", ++a),
                                                  a >= 2 &&
                    ...
                    var e = function () {
                         t(
                              ...
                              var e = t(this),
                                   ...
                                   o = e.outerWidth(),
                                   n = t(window).width() - 45 - i - o;
                              n < 0 ? e.css("left", n + "px") : e.css("left", "-15px");
                         });
                    };
               ...
               stickyHeader: function () {
                    var e = !1,
                         i = null,
                         o = null,
                         n = 992 > t(window).width(),
                         a = function (e, o, n) {
                              e.hasClass("fixed") ||
                                   (e.parent().css("min-height", o.height),
                                   i.filter(".fixed").each(function () {
                                        n += t(this).outerHeight();
                                   }),
                                   e.addClass("fixed").css("top", -o.height).animate({ top: n }),
                              ...
                              e
                                   ? o.forEach(function (e, o) {
                                          if (e.mobile === !n) {
                                               ...
                                               (e.height = a.outerHeight(!0)),
                                                    (e.offset = r.offset
                                                         ? r.offset
                                                         : a.offset().top),
                                                    (e.paddingTop = parseInt(a.css("padding-top")));
                                          } else if (e.mobile === n) {
                                               a = t(i[o]);
                                               s(a);
                                          }
                                   ...
                                   : ((o = []),
                                     (i = t(".sticky-header").each(function () {
                                          ...
                                          i &&
                                               ...
                                               (n.offset = n.offset || e.offset().top),
                                               (n.paddingTop = parseInt(e.css("padding-top"))),
                                               o.push(n),
               ...
               mMenuToggle: function () {
                    t(".sidebar-home").find(".menu-vertical").length > 0 &&
                         ...
                         t(".menu-item").on("click", function (e) {
                              t("body").toggleClass("mmenu-depart-active"),
                                   t(this).children(".menu-depart").toggleClass("opened"),
                                   e.preventDefault();
                         });
               },
               mMenuIcons: function () {
                         ...
                         t(".home-slider.with-dots-container").each(function () {
                              ...
                              o.eq(0).addClass("active"),
                                   ...
                                   o.click(function () {
                                        var o = t(this),
                                             n = (
                                                  o.parent().filter(i).length ? o : o.parent()
                                             ).index();
                                   ...
                                   e.on("translate.owl.carousel", function (e) {
                                        var n =
                                                  (e.item.index -
                                                       t(e.currentTarget).find(".cloned").length /
                                                            2 +
                                                       e.item.count) %
                                                  e.item.count,
                                             a = o.eq(n);
                                        o.filter(".active").removeClass("active"),
                                             a.addClass("active"),
                                             i.trigger("to.owl.carousel", n);
                                   });
                         }),
                         t(".home-slider-sidebar").each(function () {
                              ...
                              o.click(function () {
                                   ...
                                   i.on("translate.owl.carousel", function (i) {
                                        var n =
                                                  (i.item.index -
                                                       t(i.currentTarget).find(".cloned").length /
                                                            2 +
                                                       i.item.count) %
                                                  i.item.count,
                                             a = o.eq(n);
               ...
               lightBox: function () {
                    ...
                    (e =
                         ...
                         t(".media-with-zoom").length > 0 &&
                              (e = t(".media-with-zoom .owl-carousel .owl-item:not(.cloned) img")),
                         ...
                         t(".prod-full-screen").click(function (e) {
                              var o;
                              (o = e.currentTarget.closest(".product-slider-container")
                    ...
                    t("body")
                         ...
                         .on("click", ".link-to-tab", function (e) {
                              var i = t(this).attr("href"),
                                   o = t(i),
                                   n = o.parent().parent().find(".nav");
                              e.preventDefault(),
                                   o.siblings().removeClass("active show"),
                                   o.addClass("active show"),
                                   n.find(".nav-link").removeClass("active"),
                                   "#shipping" == i || "#billing" == i
                                        ? n.find('[href="#address"]').hasClass("address") ||
                                          n.find('[href="#address"]').addClass("address")
                                        : n.find('[href="' + i + '"]').addClass("active"),
                                   t("html").animate({ scrollTop: o.offset().top - 150 });
                         });
               },
                         ...
                         t(function () {
                              t("[data-plugin-wort-rotator], .wort-rotator:not(.manual)").each(
                                   function () {
                                        ...
                                        o && (i = o), e.themePluginWordRotator(i);
                                   },
                              );
                         });
               },
                    ...
                    e.length &&
                         e.each(function () {
                              ...
                              if (
                                   ...
                                   var p = function () {
                                        (n = e.offset()),
                                             (a = -(d.scrollTop() - (n.top - 100)) / (l.speed + 2)),
                                             (s = a < 0 ? Math.abs(a) : -Math.abs(a)),
                                             r.css({
                                                  transform:
                                                       "translate3d(0, " +
                                                       (s - 50 + l.offset) +
               ...
               isotopes: function () {
                    ...
                    t(".grid").each(function () {
                         ...
                         o && (o = JSON.parse(o.replace(/'/g, '"').replace(";", "")));
                         var n = t.extend(!0, {}, e, o),
                              a = i.isotope(n);
                         "function" == typeof imagesLoaded &&
                              t.fn.isotope &&
                              imagesLoaded(".grid", { background: !0 }).on("done", function (t, e) {
                                   window.innerWidth < 768 &&
                                        window.innerWidth > 400 &&
                                        a.isotope({ sortBy: "md-order" }),
                                        a.isotope("layout");
                              });
                         if (n.sortReorder) {
                              var s = function () {
                    ...
                    t(".loadmore").click(function (i) {
                         ...
                         o.text("Loading ..."),
                              t.ajax({
                                   url: o.attr("href"),
                                   success: function (i) {
                                        var n = t(".product-ajax-grid"),
                                             a = t(i);
                                        setTimeout(function () {
                                             a.hide().appendTo(n).fadeIn(),
                                                  o.text("Load More..."),
                                                  ++e >= 2 && o.hide();
                                        }, 350);
                                   },
                    ...
                    t(".category-list-nav")
                         ...
                         .on("click", function (e) {
                              var i = t(this).attr("href"),
                                   o = t(i);
                              if (o.length) {
                                   var n = o.offset().top - 70;
                                   t("html, body").animate({ scrollTop: n }, 700),
                                        e.preventDefault();
                              }
                         });
               },
     ...
     (c.initProductSingle = (function () {
          ...
          var i = function (t) {
                    ...
                    i <= e - t.$productThumb[0].offsetHeight
                         ...
                         : i < e
                         ? (t.$thumbs.css("top", parseInt(t.$thumbs.css("top")) - Math.ceil(i - e)),
                           t.$thumbDown.removeClass("disabled"),
               ...
               a = function (t) {
                    t.isQuickview &&
                         t.$wrapper
                              .find(".product-single-details")
                              .css(
                                   "height",
                                   window.innerWidth > 767
                                        ? t.$wrapper.find(".product-single-gallery")[0].clientHeight
                                        : "",
                              );
               };
          return (
               (e.prototype.init = function (e) {
                    var s = this,
                         r = e.find(".product-single-carousel");
                    (s.$wrapper = e),
                                   ...
                                   !(function (e) {
                                        e.$wrapper.find(".product-thumbs").length > 0
                                             ...
                                             e.$thumbsDots.on("click", function () {
                                                  var i = t(this),
                                                       o = (
                                                            i.parent().filter(e.$thumbs).length
                                                                 ? i
                                                                 : i.parent()
                                                       ).index();
                                                  e.$wrapper
               ...
               (e.prototype.thumbsSetActive = function (t) {
                    var e = this.$thumbsDots.eq(t);
                    if (
                         (this.$thumbsDots.filter(".active").removeClass("active"),
                         e.addClass("active"),
                         this.$isPgVertical.length > 0)
                    ) {
                         var i = parseInt(this.$thumbs.css("top")) + t * this.$thumbsHeight;
                         i < 0
                              ? (this.$thumbUp.hasClass("disabled") ||
                                     this.$thumbUp.addClass("disabled"),
                                this.$thumbDown.hasClass("disabled") &&
                                     this.$thumbDown.removeClass("disabled"),
                              ...
                              : (i =
                                     ...
                                     e[0].offsetHeight) < 0 &&
                                (this.$thumbUp.hasClass("disabled") &&
                                     this.$thumbUp.removeClass("disabled"),
                                this.$thumbDown.hasClass("disabled") ||
                                     this.$thumbDown.addClass("disabled"),
                                this.$thumbs.css("top", parseInt(this.$thumbs.css("top")) + i));
                    } else this.$thumbs.trigger("to.owl.carousel", t, 100);
               }),
               (e.prototype.variationCheck = function () {
                    ...
                    this.$selects.each(function () {
                         ...
                         this.$items.each(function () {
                              var i = t(this);
                              i.find("li").length && (i.find(".active").length || (e = !1));
                         }),
          ...
          (c.miniPopup =
               ...
               (l = function () {
                    if (!a)
                         for (var t = 0; t < s.length; ++t) (s[t] -= 200) <= 0 && this.close(t--);
               }),
               {
                    init: function () {
                         ...
                         (o.className = "wishlist-popup"),
                              (n.className = "wishlist-popup-msg"),
                              (n.innerText = "Product added!"),
                              t(".page-wrapper")[0].appendChild(o),
                              t(".wishlist-popup").append(n),
                    ...
                    open: function (e, a) {
                         ...
                         (u = t(d(h.template, h))),
                              (p.space = h.space),
                              (u.appendTo(i).css("top", -o).find("img")[0].onload = function () {
                                   (o += u[0].offsetHeight + p.space),
                                        u.addClass("active"),
                                        u.offset().top - window.pageYOffset < 0 &&
                                             (p.close(),
                                             u.css("top", -o + u[0].offsetHeight + p.space)),
                                        u
                                        ...
                                        n.push(u),
                                        s.push(h.delay),
                                        s.length > 1 || (r = setInterval(l, 200)),
                                        a && a(u);
                              });
                    },
                    close: function (t) {
