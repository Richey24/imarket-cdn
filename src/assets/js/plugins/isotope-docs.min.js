     ...
     (u.constructor = o),
          ...
          (u.getTranslate = function (t, i) {
               var n = this.layout._getOption("originLeft"),
                    o = this.layout._getOption("originTop");
               return (
                    (t = n ? t : -t), (i = o ? i : -i), "translate3d(" + t + "px, " + i + "px, 0)"
               );
          }),
          (u.goTo = function (t, i) {
     ...
     (u.ontransitionend = function (t) {
          if (t.target === this.element) {
               ...
               if (
                    ...
                    o in i.clean && ((this.element.style[t.propertyName] = ""), delete i.clean[o]),
                    o in i.onEnd)
               ) {
                    var e = i.onEnd[o];
...
!(function (t, e) {
     ...
     return (
          ...
          (o._manageStamp = function (e) {
               ...
               for (
                    var n = (this._getOption("originLeft") ? o.left : o.right) + i.outerWidth,
                         u = h;
                    u <= a;
                    u++
               )
...
!(function (t, i) {
     ...
     (g.itemDragMove = function (t, i, e) {
          ...
          if (r) {
               ...
               n
                    ? (clearTimeout(this.dragTimeout), (this.dragTimeout = setTimeout(s, c)))
...
FizzyDocs["commercial-license-agreement"] = function (e) {
     ...
     for (
          var l = [], a = e.querySelectorAll("[data-license-property]"), c = 0, s = a.length;
          c < s;
          c++
     ) {
          var p = a[c],
