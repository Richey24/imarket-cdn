     ...
     var Porto = {
          ...
          menuInit: function () {
               ...
               var calculateMegaMenuPosition = function () {
                    $(".menu:not(.menu-vertical):not(.no-superfish) .megamenu-fixed-width").each(
                         function () {
                              var $menu = $(this),
               ...
               if (self.$isPgVertical.length > 0) {
                    ...
                    if (
                         ...
                         self.$thumbs
                              ...
                              .owlCarousel($.extend(true, self.isQuickview ? {} : {}, sliderThumb));
                    }
               }
          };
