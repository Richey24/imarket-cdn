                              ...
                              ? (0 < n.decimals && "." === t) ||
                                ...
                                (i = (function (t) {
                                     switch (n.forcestepdivisibility) {
                                          ...
                                          case "ceil":
                                               return (Math.ceil(t / n.step) * n.step).toFixed(
                                                    n.decimals,
                                               );
                                          default:
                                               return t;
     ...
     (function (t) {
          ...
          (g.prototype = {
               ...
               _openClick: function (i, o, s) {
                    if (
                         (void 0 !== s.midClick ? s.midClick : t.magnificPopup.defaults.midClick) ||
          ...
          (s.Defaults = {
               ...
               (s.prototype.update = function () {
                    for (
                         ...
                         (this._invalidated.all || t.grep(this._pipe[e].filter, o).length > 0) &&
                              this._pipe[e].run(s),
                              e++;
               ...
               (s.prototype.play = function (e) {
                    ...
                    this._playing ||
                         ...
                         "youtube" === s.type
                              ...
                              : "vzaar" === s.type &&
                                i.attr("src", "//view.vzaar.com/" + s.id + "/player?autoplay=true"),
                         t(i)
               ...
               w =
                    ...
                    (u = function (e) {
                         (e.retainPath = t.inArray(this[0], e.$path) > -1),
                              ...
                              this.parents("." + e.hoverClass).length ||
                                   (e.onIdle.call(p(this)),
                                   e.$path.length && t.proxy(d, e.$path)());
                    }),
                    (m = function () {
                         var e = t(this),
                              i = c(e);
                    ...
                    (g = function (e, i) {
                         ...
                         t.fn.hoverIntent && !i.disableHI
                              ? e.hoverIntent(d, m, o)
                              : e.on("mouseenter.superfish", o, d).on("mouseleave.superfish", o, m);
                         ...
                         switch (i.options.zoomWindowPosition) {
                              ...
                              case 2:
                                   i.options.zoomWindowHeight > i.nzHeight &&
                                        ((i.windowOffsetTop =
                                             -1 *
                                             (i.options.zoomWindowHeight / 2 - i.nzHeight / 2)),
                                        (i.windowOffsetLeft = i.nzWidth));
                                   break;
                              case 3:
                                   (i.windowOffsetTop =
                              ...
                              case 8:
                                   (i.windowOffsetTop = i.nzHeight),
                                        (i.windowOffsetLeft =
                                             -1 *
                                             (i.zoomWindow.width() + 2 * i.options.borderSize));
                                   break;
                              case 9:
                                   (i.windowOffsetTop =
                                        i.nzHeight -
                              ...
                              case 14:
                                   i.options.zoomWindowHeight > i.nzHeight &&
                                        ((i.windowOffsetTop =
                                             -1 *
                                             (i.zoomWindow.height() + 2 * i.options.borderSize)),
                                        (i.windowOffsetLeft =
                                             -1 *
                                             (i.options.zoomWindowWidth / 2 -
                                                  i.nzWidth / 2 +
                                   ...
                                   ? (i.xp || (i.xp = 0),
                                     ...
                                     i.loop ||
                                          (i.loop = setInterval(function () {
                                               (i.xp +=
                                                    (i.windowLeftPos - i.xp) /
                                                    i.options.easingAmount),
                                                    (i.yp +=
                                                         (i.windowTopPos - i.yp) /
                                                         i.options.easingAmount),
                                                    i.scrollingLock
                                                         ? (clearInterval(i.loop),
                                                           ...
                                                           (i.xp =
                                                                -1 *
                                                                ((e.pageX - i.nzOffset.left) *
                                                                     i.widthRatio -
                                                                     i.zoomWindow.width() / 2)),
                                                           (i.yp =
                                                                -1 *
                                                                ((e.pageY - i.nzOffset.top) *
                                                                     i.heightRatio -
                                                                     i.zoomWindow.height() / 2)),
                                                           i.changeBgSize &&
                              ...
                              if (e.minWidth && r.width() <= e.minWidth)
                                   ...
                                   if (void 0 !== p) {
                                        ...
                                        var d = t.extend({ top: 0, bottom: 0 }, e.padding || {}),
                                             ...
                                             m = parseInt(
                                                  a.parent().parent().css("padding-bottom"),
                                             );
                              ...
                              for (
                                   ...
                                   if (f) {
                                        ...
                                        if (
                                             ...
                                             l[c] != f.to &&
                                                  h[c] &&
                                                  m.height() + m.offset().top + f.pad.bottom <
                                                       i + p &&
                                                  (h[c] = !1),
                                             w)
                                        ) {
                                             ...
                                             var z = parseInt(
                                                  m.parent().parent().css("padding-top"),
                                             );
                    ...
                    case "3D":
                         if (s) {
                              ...
                              i.body ||
                                   ...
                                   (r =
                                        void 0 !==
                                             (n = e.getComputedStyle(o).getPropertyValue(a)) &&
                                        n.length > 0 &&
                                        "none" !== n),
                                   (d.style.overflow = u),
                                   c.removeChild(o),
