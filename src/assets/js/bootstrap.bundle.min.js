...
!(function (e, t) {
          ...
          var r,
               ...
               Se =
                    ...
                    k(document).on(q.CLICK_DATA_API, ne, re._dataApiClickHandler),
                         k(window && typeof window !== "undefined").on(q.LOAD_DATA_API, function () {
                         for (
                         ...
                         return (
                              ...
                              (e.show = function () {
                                   ...
                                   if (
                                        ...
                                        if (
                                             (oe(this._element).trigger(i), !i.isDefaultPrevented())
                                        ) {
                                             e &&
                              ...
                              (e.hide = function () {
                                   ...
                                   if (!this._isTransitioning && oe(this._element).hasClass(de)) {
                                        ...
                                        if (
                                             (oe(this._element).trigger(t), !t.isDefaultPrevented())
                                        ) {
                              ...
                              (e._addAriaAndCollapsedClass = function (e, t) {
                                   if (e) {
                                        ...
                                        t.length &&
                                             oe(t).toggleClass(ge, !n).attr("aria-expanded", n);
                                   }
                              }),
     ...
     function qe(e, t) {
          ...
          return (
               parseFloat(e["border" + n + "Width"], 10) + parseFloat(e["border" + i + "Width"], 10)
          );
     }
     function Ke(e, t, n, i) {
          return Math.max(
