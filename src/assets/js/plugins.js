...
!(function (o) {
     ...
     j.fn.TouchSpin = function (y) {
          ...
          return this.each(function () {
                         ...
                         ? (0 < i.decimals && "." === t) ||
                           ...
                           (o = (function (t) {
                                switch (i.forcestepdivisibility) {
                                     ...
                                     case "ceil":
                                          return (Math.ceil(t / i.step) * i.step).toFixed(
                                               i.decimals,
                                          );
                                     default:
                                          return t;
               ...
               function _() {
                    switch (
                         (clearTimeout(e), clearTimeout(r), clearInterval(t), clearInterval(n), f)
                    ) {
                         case "up":
          ...
          var n = {
               init: function (i, t) {
                    ...
                    (e.elem = t),
                         ...
                         e.options.zoomContainer
                              ? (e.$container = o(e.options.zoomContainer))
                              : (e.$container = o("body")),
               ...
               startZoom: function () {
                    ...
                    "window" == i.options.zoomType &&
                         (i.nzHeight < i.options.zoomWindowWidth / i.widthRatio
                              ? (lensHeight = i.nzHeight)
                              : (lensHeight = String(i.options.zoomWindowHeight / i.heightRatio)),
                         i.largeWidth < i.options.zoomWindowWidth
                              ? (lensWidth = i.nzWidth)
                              : (lensWidth = i.options.zoomWindowWidth / i.widthRatio),
                         (i.lensStyle =
                              "background-position: 0px 0px;width: " +
               ...
               showHideWindow: function (o) {
                    ...
                    "show" == o &&
                         (i.isWindowActive ||
                              (i.options.zoomWindowFadeIn
                                   ? i.zoomWindow
                                          .stop(!0, !0, !1)
                                          .fadeIn(i.options.zoomWindowFadeIn)
                                   : i.zoomWindow.show(),
                              (i.isWindowActive = !0))),
                         "hide" == o &&
                              i.isWindowActive &&
                              (i.options.zoomWindowFadeOut
                                   ? i.zoomWindow
                                          .stop(!0, !0)
                                          .fadeOut(i.options.zoomWindowFadeOut, function () {
                         ...
                         switch (t.options.zoomWindowPosition) {
                              ...
                              case 2:
                                   t.options.zoomWindowHeight > t.nzHeight &&
                                        ((t.windowOffsetTop =
                                             -1 *
                                             (t.options.zoomWindowHeight / 2 - t.nzHeight / 2)),
                                        (t.windowOffsetLeft = t.nzWidth));
                                   break;
                              case 3:
                                   (t.windowOffsetTop =
                              ...
                              case 8:
                                   (t.windowOffsetTop = t.nzHeight),
                                        (t.windowOffsetLeft =
                                             -1 *
                                             (t.zoomWindow.width() + 2 * t.options.borderSize));
                                   break;
                              case 9:
                                   (t.windowOffsetTop =
                                        t.nzHeight -
                              ...
                              case 14:
                                   t.options.zoomWindowHeight > t.nzHeight &&
                                        ((t.windowOffsetTop =
                                             -1 *
                                             (t.zoomWindow.height() + 2 * t.options.borderSize)),
                                        (t.windowOffsetLeft =
                                             -1 *
                                             (t.options.zoomWindowWidth / 2 -
                                                  t.nzWidth / 2 +
                                   ...
                                   ? (t.xp || (t.xp = 0),
                                     ...
                                     t.loop ||
                                          (t.loop = setInterval(function () {
                                               (t.xp +=
                                                    (t.windowLeftPos - t.xp) /
                                                    t.options.easingAmount),
                                                    (t.yp +=
                                                         (t.windowTopPos - t.yp) /
                                                         t.options.easingAmount),
                                                    t.scrollingLock
                                                         ? (clearInterval(t.loop),
                                                           ...
                                                           (t.xp =
                                                                -1 *
                                                                ((i.pageX - t.nzOffset.left) *
                                                                     t.widthRatio -
                                                                     t.zoomWindow.width() / 2)),
                                                           (t.yp =
                                                                -1 *
                                                                ((i.pageY - t.nzOffset.top) *
                                                                     t.heightRatio -
                                                                     t.zoomWindow.height() / 2)),
                                                           t.changeBgSize &&
                    ...
                    e.options.loadingIcon &&
                         ...
                         (n.onload = function () {
                              (e.largeWidth = n.width),
                                   ...
                                   e.zoomWindow.css({
                                        "background-size":
                                             e.largeWidth + "px " + e.largeHeight + "px",
                                   }),
                                   e.swapAction(i, t);
                         }),
                         (n.src = t);
               ...
               for (var i = 0, len = elements.length; i < len; i++) {
                    ...
                    if (isFitToTop) {
                         ...
                         data.to =
                              ...
                              data.pb;
                         data.to2 =
                              $container.height() - $this.outerHeight() - data.pad.bottom - data.pb;
                    }
                    ...
                    if (prevDataTo[i] != data.to) {
                         if (
                              fixedSideBottom[i] &&
                              $this.height() + $this.offset().top + data.pad.bottom <
                    ...
                    if (isFitToTop) {
                         ...
                         $this.height() + data.pad.top + data.pad.bottom > window_height ||
                         fixedSideTop[i] ||
                         fixedSideBottom[i]
                    ) {
