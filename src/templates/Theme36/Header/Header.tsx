...
export default function Header() {
     return (
              ...
              <div className="container">
                  <div className="header-left col-lg-2 w-auto pl-0">
                      ...
                      <a href="demo36.html" className="logo">
                          <img src="assets/images/your-logo.png" className="w-100" width="111" height="44"
                              alt="Porto Logo"/>
                      </a>
                  </div>
                  ...
                  <div className="header-right w-lg-max">
                      <div
                          className="header-icon header-search header-search-inline header-search-category w-lg-max text-right mb-0">
                      ...
                      <a href="wishlist.html" className="header-icon position-relative" title="wishlist">
                              ...
                              <div className="dropdownmenu-wrapper custom-scrollbar">
                                  ...
                                  <div className="dropdown-cart-products">
                                      <div className="product">
                                          ...
                                          <figure className="product-image-container">
                                              <a href="demo36-product.html" className="product-image">
                                                  <img src="assets/images/demoes/demo36/products/product-1.jpg"
                                      ...
                                      <div className="product">
                                          ...
                                          <figure className="product-image-container">
                                              <a href="demo36-product.html" className="product-image">
                                                  <img src="assets/images/demoes/demo36/products/product-2.jpg"
                                                      alt="product" width="80" height="80"/>
                                              </a>
                                      ...
                                      <div className="product">
                                          ...
                                          <figure className="product-image-container">
                                              <a href="demo36-product.html" className="product-image">
                                                  <img src="assets/images/demoes/demo36/products/product-3.jpg"
                                                      alt="product" width="80" height="80"/>
                                              </a>
                                              <a href="#" className="btn-remove" title="Remove Product"><span>×</span></a>
                                          </figure>
          ...
          <div className="header-bottom sticky-header d-none d-lg-flex" data-sticky-options="{'mobile': false}">
              <div className="container">
                      ...
                      <ul className="menu w-100">
                          <li className="menu-item tw-group">
                              <a className="d-inline-flex align-items-center sf-with-ul text-white">
                                  <i className="custom-icon-toggle-menu d-inline-table"></i><span>ALL
                                      DEPARTMENTS</span></a>
                              ...
                              <div className="menu-depart group-hover:tw-block group-hover:tw-visible group-hover:tw-h-auto group-hover:tw-opacity-100">
                                  <ul className="menu menu-vertical sf-arrows d-block no-superfish">
                                      <li>
                                          <a href="#"><i className="icon-category-fashion"></i>Fashion</a>

                                          <div className="megamenu megamenu-fixed-width megamenu-one">
                                              <div className="row">
                                                  <div className="col-lg-3 mb-1 pb-2">
                                                      <a href="#" className="nolink pl-0">WOMAN</a>
                                                      ...
                                                      <a href="#" className="nolink pl-0">JEWELLERY</a>
                                                      <ul className="submenu">
                                                  ...
                                                  <div className="col-lg-4">
                                                      <a href="#" className="nolink pl-0">MAN</a>
                                                      <ul className="submenu">
                                                          <li><a href="demo36-shop.html">Accessories</a></li>
                                                      ...
                                                      <a href="#" className="nolink pl-0">KIDS FASHION</a>
                                                      <ul className="submenu">
                                                      ...
                                                      <div className="menu-banner menu-banner-2">
                                                          <figure>
                                                              <img src="assets/images/demoes/demo40/menu-banner-1.jpg"
                                                                  alt="Menu banner" className="product-promo w-100"/>
                                                          </figure>
                                                          <i>OFF</i>
                                                      ...
                                                      <div className="partners-container row">
                                                          <div className="col-xl-5col">
                                                              <div className="partner">
                                                                  <img src="assets/images/brands/small/brand1.png"
                                                                      alt="logo image" width="140" height="60"/>
                                                              </div>
                                                          </div>
                                                          <div className="col-xl-5col">
                                                              <div className="partner">
                                                                  <img src="assets/images/brands/small/brand2.png"
                                                                      alt="logo image" width="140" height="60"/>
                                                              </div>
                                                          </div>
                                                          <div className="col-xl-5col">
                                                              <div className="partner">
                                                                  <img src="assets/images/brands/small/brand3.png"
                                                                      alt="logo image" width="140" height="60"/>
                                                              </div>
                                                          </div>
                                                          <div className="col-xl-5col">
                                                              <div className="partner">
                                                                  <img src="assets/images/brands/small/brand4.png"
                                                                      alt="logo image" width="140" height="60"/>
                                                              </div>
                                                          </div>
                                                          <div className="col-xl-5col">
                                                              <div className="partner">
                                                                  <img src="assets/images/brands/small/brand5.png"
                                                                      alt="logo image" width="140" height="60"/>
                                                              </div>
                                                          </div>
                                                      </div>
                                      ...
                                      <li>
                                          <a href="#"><i className="icon-category-electronics"></i>Electronics</a>

                                          <div className="megamenu megamenu-fixed-width megamenu-two">
                                              <div className="row">
                                                  <div className="col-lg-3">
                                                      <a href="#" className="nolink pl-0">ACCESSORIES</a>
                                                      <ul className="submenu">
                                                  ...
                                                  <div className="col-lg-3 pl-xl-2">
                                                      <a href="#" className="nolink pl-0">AUDIO & VIDEO</a>
                                                      <ul className="submenu">
                                                  ...
                                                  <div className="col-lg-3 pl-xl-0">
                                                      <a href="#" className="nolink pl-0">CAMERA & PHOTO</a>
                                                      <ul className="submenu">
                                                  ...
                                                  <div className="col-lg-3 pl-xl-0">
                                                      <a href="#" className="nolink pl-0">LAPTOPS</a>
                                                      <ul className="submenu">
                                                  ...
                                                  <div className="banner-container w-100 pl-3 pr-3 d-lg-block d-none">
                                                      <div className="row">
                                                          <div className="col-md-6">
                                                              <div
                                                                  className="banner banner7 banner-md-vw text-transform-none">
                                                                  <figure>
                                                                      <img src="assets/images/demoes/demo40/menu-banner-2.jpg"
                                                                          alt="banner"/>
                                                                  </figure>
                                                                  ...
                                                                  <div
                                                                      ...
                                                                      <div className="content-left">
                                                                          <h4
                                                                              className="banner-layer-circle-item mb-0 ls-0">
                                                                              40<sup>%<small
                                                                                      className="ls-0">OFF</small></sup>
                                                                          </h4>
                                                                      </div>
                                                          ...
                                                          <div className="col-md-6">
                                                              <div className="banner banner8 banner-md-vw">
                                                                  <figure>
                                                                      <img src="assets/images/demoes/demo40/menu-banner-3.jpg"
                                                                          alt="banner"/>
                                                                  </figure>
                                                                  ...
                                                                  <div
                                                                      ...
                                                                      <div className="coupon-sale-content">
                                                                          <h4
                                                                              className="menu-coupon-sale-text bg-dark text-white d-block font1 text-transform-none">
                                                                              Exclusive COUPON
                                                                          </h4>
                                                                          <h5
                                                                              className="custom-coupon-sale-text font1 text-dark ls-n-10 p-0">
                                      ...
                                      <li>
                                          <a href="#"><i className="icon-category-gifts"></i>Gifts</a>

                                          <div className="megamenu megamenu-fixed-width megamenu-three">
                                              <div className="row">
                                                  <div className="col-lg-3">
                                                      <a href="#"
                                                          className="nolink pl-0 d-flex flex-column align-items-start"><i
                                                              className="icon-boy-broad-smile"></i>FOR HIM</a>
                                                  ...
                                                  <div className="col-lg-3 pl-xl-2">
                                                      <a href="#"
                                                          className="nolink pl-0 d-flex flex-column align-items-start"><i
                                                              className="icon-smiling-girl"></i>FOR HER</a>
                                                      <ul className="submenu pb-0">
                                                  ...
                                                  <div className="col-lg-3 pl-xl-0">
                                                      <a href="#"
                                                          className="nolink pl-0 d-flex flex-column align-items-start"><i
                                                              className="icon-smiling-baby"></i>FOR KIDS</a>
                                                      <ul className="submenu pb-0">
                                                  ...
                                                  <div className="col-lg-3 pl-xl-0">
                                                      <a href="#"
                                                          className="nolink pl-0 d-flex flex-column align-items-start"><i
                                                              className="icon-gift-2"></i>BIRTHDAY</a>
                                                      <ul className="submenu pb-0">
                                      ...
                                      <li>
                                          <a href="#"><i className="icon-category-garden"></i>Home & Garden</a>

                                          <div className="megamenu megamenu-fixed-width megamenu-four">
                                              <div className="row">
                                                  <div className="col-lg-4 mb-1 pb-2">
                                                      <a href="#" className="nolink pl-0 d-lg-none d-block">VARIATION
                                                          1</a>
                                                      <a href="#" className="nolink pl-0">FURNITURE</a>
                                                      <ul className="submenu">
                                                      ...
                                                      <a href="#" className="nolink pl-0">HOME ACCESSORIES</a>
                                                      <ul className="submenu pb-0">
                                                  ...
                                                  <div className="col-lg-4">
                                                      <a href="#" className="nolink pl-0 d-lg-none d-block">VARIATION
                                                          2</a>
                                                      <a href="#" className="nolink pl-0">LIGHTING</a>
                                                      <ul className="submenu">
                                                      ...
                                                      <a href="#" className="nolink pl-0">GARDEN & OUTDOORS</a>
                                                      <ul className="submenu pb-0">
                                                  ...
                                                  <div className="col-lg-4 d-lg-block d-none">
                                                      <div className="product-widgets-container">
                                                          <div className="product-default left-details product-widget">
                                                              <figure>
                                                                  <a href="demo36-product.html">
                                                                      <img src="assets/images/demoes/demo36/products/small/product-1.jpg"
                                                              ...
                                                              <div className="product-details">
                                                                  <h3 className="product-title"> <a
                                                                          href="demo36-product.html">PT Speaker</a>
                                                                  </h3>

                                                                  <div className="ratings-container">

                                                                      <div className="product-ratings">
                                                                          <span className="ratings tw-w-full"
                                                                              ></span>
                                                          ...
                                                          <div className="product-default left-details product-widget">
                                                              <figure>
                                                                  <a href="demo36-product.html">
                                                                      <img src="assets/images/demoes/demo36/products/small/product-2.jpg"
                                                                          width="84" height="84" alt="product"/>
                                                                  </a>
                                                              </figure>
                                                          ...
                                                          <div className="product-default left-details product-widget">
                                                              <figure>
                                                                  <a href="demo36-product.html">
                                                                      <img src="assets/images/demoes/demo36/products/small/product-3.jpg"
                                                                          width="84" height="84" alt="product"/>
                                                                  </a>
                                                              </figure>
                                                          ...
                                                          <div className="product-default left-details product-widget">
                                                              <figure>
                                                                  <a href="demo36-product.html">
                                                                      <img src="assets/images/demoes/demo36/products/small/product-4.jpg"
                                                                          width="84" height="84" alt="product"/>
                                                                  </a>
                                                              </figure>
                                                              ...
                                                              <div className="product-details">
                                                                  <h3 className="product-title"> <a
                                                                          href="demo36-product.html">Camera</a> </h3>                       
                                                                  <div className="price-box">
                                                                      <span className="product-price">$49.00</span>
                                                                  </div>
                                                          ...
                                                          <div className="product-default left-details product-widget">
                                                              <figure>
                                                                  <a href="demo36-product.html">
                                                                      <img src="assets/images/demoes/demo36/products/small/product-5.jpg"
                                                                          width="84" height="84" alt="product"/>
                                                                  </a>
                                                              </figure>
                                      ...
                                      <li>
                                          <a href="#"><i className="icon-category-music"></i>Gaming</a>

                                          <div className="megamenu megamenu-fixed-width megamenu-five text-transform-none"
                                          style={{backgroundImage:"url(assets/images/demoes/demo40/menu-banner-4.jpg)"}}>
                                              <div className="row">
                                                  <div className="col-lg-4 pt-0">
                                                      <a href="#" className="nolink pl-0">INSTRUMENTS</a>
                                                      ...
                                                      <a href="#" className="nolink pl-0">EXTRA</a>
                                                  ...
                                                  <div className="col-lg-8 pt-0 d-lg-block d-none">
                                                      <div
                                                          className="banner banner9 mb-2 h-100 d-flex align-items-center">
                                                          <div className="banner-layer text-right pt-0">
                                                              ...
                                                              <h2 className="text-transform-none text-white">
                                                                  HEADPHONES</h2>
                                                              <a href="demo36-shop.html" className="btn btn-dark">VIEW
                                                                  ALL NOW</a>
                                                          </div>
                                      ...
                                      <li>
                                          ...
                                          <div className="megamenu megamenu-fixed-width megamenu-four megamenu-product">
                                              <div className="row">
                                                  ...
                                                  <div className="col-lg-3">
                                                      <a href="#" className="nolink pl-0 pt-2">SHOP BY PRICE</a>
                                                      ...
                                                      <a href="#" className="nolink pl-0">SHOP BY NRAND</a>
                                                      <ul className="submenu pb-0">
                                                  ...
                                                  <div className="col-lg-5 d-lg-block d-none menu-product">
                                                      <div className="owl-carousel owl-theme show-nav-hover nav-outer dots-small"
                                                          data-owl-options="{
                                                          'items': 1,
                                                          'loop': false
                                                      }">
                                                          <div className="product-default">
                                                              ...
                                                              <div className="product-details">
                                                                  ...
                                                                  <div className="ratings-container">
                                                                      ...
                                                                      <div className="product-ratings">
                                                                          <span className="ratings tw-w-4/5 "
                                                                              ></span>
                                                                  ...
                                                                  <div className="product-countdown-container">
                                                                      <span className="product-countdown-title">offer ends
                                                                          in:</span>
                                      ...
                                      <div className="col-lg-4 p-0">
                                          <div className="menu-banner">
                                              ...
                                              <div className="banner-content">
                                                  ...
                                                  <a href="demo36-shop.html" className="btn btn-sm btn-dark">SHOP NOW</a>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
                          ...
                          <li className="float-right phone"><a href="#" className="d-flex align-items-center"><i
                                      className="icon-phone-1"></i>1-800-234-5678</a>
                          </li>
                          <li className="float-right"><a href="https://1.envato.market/DdLk5" target="_blank">NEW
                                  ARRIVALS</a></li>
                          <li className="float-right"><a href="#">FLASH DEALS</a></li>
                      </ul>
                  </nav>
              </div>
          </div>
