          ...
          <div>
               <section className="product-section">
                    <div className="container">
                         <div className="product-default product-extend product-row">
                              <figure>
                                   <Image
                                        src={templateImages.demo28.bannerImage.banner5}
                                        alt="banner"
                                        width="640"
                                        height="479"
                                   />
                              ...
                              <div className="product-details">
                                   ...
                                   <p className="product-desc">
                                        ...
                                        tempus nibh sed elimttis adipiscing. Fusce in hendrerit
               ...
               >
                    <div className="section-body d-flex flex-column align-items-center justify-content-center">
                         ...
                         <a
                              href="https://www.youtube.com/watch?v=YbJOTdZBX1g"
                              className="btn play-btn btn-iframe"
                         >
