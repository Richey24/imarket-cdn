          ...
          <div>
               <section className="rotating-section" id="tour">
                    <div className="heading-wrapper text-center">
                         ...
                         <h4
                              className="section-subtitle line-height-1 "
                              data-animation-name="fadeInUpShoretr"
                    ...
                    <svg
                         className="position-absolute w-100 h-100 z-index-2 p-events-none"
                         viewBox="0 0 120 120"
                         version="1.1"
                    ...
                    >
                         <circle
                              ...
                              stroke-width="0.3"
                              fill="transparent"
                              data-animation-name="customSVGLineAnimTwo"
                              data-animation-delay="200"
                         ></circle>
                    </svg>
                    <div
                         className="cd-product-viewer-wrapper loaded"
                         data-frame="16"
                         data-friction="0.33"
                    >
                         <div>
                              <figure
                                   className="product-viewer  fadeInUp"
                              ...
                              <div className="cd-product-viewer-handle">
                                   ...
                                   <span className="handle" style={{ left: "66.7%" }}>
                                        Handle
                         ...
                         <div className="product-row row">
                              <div className="heading col-lg-8">
                                   ...
                                   <p className="section-text text-white ls-0">
                                        ...
                                        Mauris vitae scelerisque elit. Vestibulum vulputate felis
                                        dolor. Nulla facilisi. Mauris mattis, sem non egestas
                                        euismod.
                                   </p>
                              </div>
