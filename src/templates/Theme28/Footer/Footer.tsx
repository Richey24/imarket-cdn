                ...
                <div className="container">
                    <div className="footer-top">
                        <a href="demo28.html" className="footer-logo">
                            <Image src={templateImages.logoImage.logo2} alt="footer=logo" width="202" height="80" />
                        </a>
                    </div>
                    ...
                    <div className="footer-bottom d-lg-flex justify-content-between align-items-center flex-wrap">
                        <p className="footer-copyright py-3 pr-4 mb-0">© Dreamtechlabs 2021. All Rights Reserved.</p>
                        ...
                        <div className="social-icons">
                            ...
                            <a href="#" className="social-icon social-linkedin fab fa-linkedin-in" target="_blank"></a>
                        </div>
                    </div>
                </div>
            </footer>
