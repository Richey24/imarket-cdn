        ...
        <div>
            <section className="section-1 pt-0">
                <Slider {...settings}>
                    <div className="home-banner banner-left theBanner">
                        <div className="container position-relative">
                            <div className="banner-layer banner-layer-middle">
                                <h2 className="m-b-1 banner-title" data-animation-duration="1200"
                                ...
                                <h3 className="text-uppercase rotated-upto-text mb-0 position-relative"
                                    data-animation-delay="800" data-animation-duration="1200"
                                    data-animation-name="blurIn">
                                    <small>Up to</small>50% Off
                                </h3>

                                <hr className="divider-short-thick" data-animation-duration="1200"
                                    data-animation-delay="800" data-animation-name="fadeIn" />

                                <h5 className="text-uppercase d-inline-block ls-n-20 pr-1 pt-2"
                                    data-animation-delay="1600" data-animation-duration="1200"
                                    data-animation-name="fadeIn">Starting at
                                    <span>$
                                        <strong>1</strong>99</span>
                                </h5>
                                <a href="demo17-shop.html" className="btn btn-dark btn-xl btn-icon-right"
                    ...
                    <div className="home-banner bg-img secondBanner"
                        style={{ backgroundImage: `url(${templateImages.demo17.sliderImage.slide5})`, backgroundColor: "#c0bec1" }}>
                        <div className="container position-relative">
                            <div className="banner-layer banner-layer-middle">
                                <h2 className="m-b-1 banner-title" data-animation-duration="1200"
                                    data-animation-delay="800" data-animation-name="fadeIn">Deals are Here!</h2>
                                <h3 className="text-uppercase rotated-upto-text mb-0 position-relative"
                                    data-animation-duration="1200" data-animation-delay="800"
                                    data-animation-name="blurIn">
                                    <small>Up to</small>50% Off
                                </h3>
