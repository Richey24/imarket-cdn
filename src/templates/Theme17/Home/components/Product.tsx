                                ...
                                <div className="product-default inner-quickview inner-icon">
                                    <figure>
                                        ...
                                        <div className="btn-icon-group">
                                            <button className="btn-icon btn-add-cart product-type-simple" data-toggle="modal"
                                    ...
                                    <div className="product-details">
                                        <div className="category-wrap">
                                            <div className="category-list">
                                                <a href="demo17-shop.html" className="product-category">{product.productCategory}</a>,
                                            </div>
                                        ...
                                        <h3 className="product-title"> <a href="demo17-product.html">{product.productTitle}</a> </h3>
