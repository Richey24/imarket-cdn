        ...
        <div>
            <section className="section-3 category-banner-section container">
                <div style={{ display: "flex", columnGap: "20px" }}>
                    <div style={{ width: "33%" }} className="cat-banner bg-dark" data-animation-name="fadeInRightShorter">
                        <figure>
                            <Image src={templateImages.demo17.brandImage.brand1} alt="brand" width="140"
                                height="60" className="w-auto" />
                        </figure>
                        ...
                        <div className="cat-content d-inline-block position-relative">
                            ...
                            <a href="demo17-shop.html" className="btn btn-xl btn-icon-right" role="button">Shop Now
                    ...
                    <div style={{ width: "33%" }} className="cat-banner bg-dark" data-animation-name="fadeInRightShorter">
                        <figure>
                            <Image src={templateImages.demo17.brandImage.brand2} alt="brand" width="140"
                                height="60" className="w-auto" />
                        </figure>
                        ...
                        <div className="cat-content d-inline-block position-relative">
                            ...
                            <a href="demo17-shop.html" className="btn text-dark btn-xl btn-icon-right" role="button">Shop
                                Now
                                <i className="fas fa-long-arrow-alt-right"></i>
                            </a>
                        </div>
                    ...
                    <div style={{ width: "33%" }} className="cat-banner bg-dark" data-animation-name="fadeInRightShorter">
                        <figure>
                            <Image src={templateImages.demo17.brandImage.brand3} alt="brand" width="140"
                                height="60" className="w-auto" />
                        </figure>
                ...
                <div className="newsletter-section bg-dark mt-4 mb-4">
                    <div className="d-flex flex-wrap align-items-center align-items-lg-start">
                        ...
                        <div className="col-md-6 widget-newsletter px-3">
                            <form action="#" className="d-flex justify-content-center mb-0 ml-auto mr-auto mb-md-0">
