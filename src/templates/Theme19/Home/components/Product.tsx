                                   ...
                                   <div className="row">
                                        <div className="col-lg-6">
                                             ...
                                             >
                                                  ...
                                                  <div className="banner-layer banner-layer-middle row align-items-center flex-md-nowrap">
                                                       <div className="col-auto offset-4">
                                                            <div className="coupon-sale-text">
                                                                 <h4 className="m-b-2 font1 d-block text-white bg-dark">
                                                                      Exclusive COUPON
                                                                 </h4>
                                                       ...
                                                       <div className="col-md-4 offset-md-0 offset-4">
                                                            <h3 className="font1 ls-10 text-md-center text-uppercase mb-0">
                                                                 Drone &amp; Cameras
                                                            </h3>
                                                       </div>
                                                  </div>
                                             ...
                                             >
                                                  ...
                                                  <div className="banner-layer banner-layer-middle row align-items-center">
                                                       <div className="col-md-4 col-md-4 offset-4">
                                                            <h3 className="ls-10 text-uppercase text-white text-md-center m-b-2 mb-lg-0">
                                                                 Electronic Deals
                                                            </h3>
                                                       </div>
                                                       <div className="col-auto offset-md-0 offset-4">
                                                            <div className="coupon-sale-text">
                                                                 <h4 className="m-b-2 font1 d-block text-dark bg-white">
                                                                      Exclusive COUPON
                                                                 </h4>
                                                                 <h5 className="mb-0 font1 d-inline-block">
                                                                      <i className="text-white ls-0">
                                                                           UP TO
                                                                      </i>
                                   ...
                                   <div className="row">
                                        <div className="col-lg-6">
                                             ...
                                             >
                                                  ...
                                                  <div className="banner-layer banner-layer-middle d-flex justify-content-between align-items-center">
                                                       <div className="content-left">
                                                            <h5 className="font1 text-uppercase m-b-1">
                                                                 Be a Kendo Warrior
                                                            </h5>
                                                            <h3 className="font1 text-white text-uppercase ls-n-20 mb-0">
                                                                 ProWarrior
                                                            </h3>
                                                       </div>
                              ...
                              >
                                   <div className="row">
                                        <div className="col-lg-6 d-flex">
                                             <div
                                                  className="banner banner7 m-b-4"
                                                  style={{ backgroundColor: "#f4f4f4" }}
                                             >
                                                  <figure>
                                                       <Image
                                                  ...
                                                  <div className="banner-layer banner-layer-middle d-flex justify-content-between align-items-center">
                                                       <div className="content-left text-center">
                                                            <h5 className="heading-border text-dark text-uppercase m-b-1">
                                                                 Amazing
                                                            </h5>
                                                            <h3 className="font1 ls-n-10 text-uppercase m-b-2">
                                                                 Collection
                                                            </h3>
                                                       ...
                                                       <div className="content-right text-center">
                                                            <h4 className="text-uppercase ls-n-20 m-b-2">
                                                                 Starting AT
                                                                 <sup>$</sup>199<sup>99</sup>
                                                            </h4>
                                                            <h6 className="text-body text-uppercase mb-0">
                                                                 * limited time only
                                                            </h6>
                                                       </div>
                                                  </div>
                                        ...
                                        <div className="col-lg-6">
                                             <div className="banner banner8 d-flex align-items-center justify-content-center m-b-4">
                                                  <div className="row no-gutters banner-layer position-static justify-content-center align-items-center m-t-3 px-3">
                                                       <div className="col-auto d-flex flex-column justify-content-center text-center">
                                                            <h4 className="align-left text-uppercase mb-0">
                                                                 Furniture &amp; Garden
                                                            </h4>
                                                            <h3 className="text-white m-b-3 align-left text-uppercase">
                                                                 Huge Sale
                                                            </h3>
                                                       </div>
                                   ...
                                   <div className="row">
                                             ...
                                             >
                                                  ...
                                                  <div className="banner-layer banner-layer-middle d-flex justify-content-between align-items-center">
                                                       <div className="content-left coupon-sale-text">
                                                            <h5 className="mb-0 font1 d-inline-block ls-10 text-white">
                                                       ...
                                                       <div className="content-right">
                                                            <h4 className="font1 text-uppercase m-b-1">
                                                                 Flash Sales On
                                                            </h4>
                                                            <h3 className="font1 text-white text-uppercase mb-0">
                                                                 Nice Shoes
                                                            </h3>
                                                       </div>
                                                  </div>
                                        ...
                                        <div className="col-lg-6">
                                             ...
                                             >
                                                  ...
                                                  <div className="banner-layer banner-layer-middle row no-gutters d-flex align-items-center justify-content-between justify-content-lg-start flex-nowrap overflow-hidden m-0">
                                                       <div className="col-auto col-lg-4 text-right ml-4 ml-lg-0">
                                                            <h6 className="font1 text-uppercase text-body m-b-1">
                                                                 Feel like a player
                                                            </h6>
                                                            <h3 className="font1 text-uppercase ls-n-25 mb-0">
                                                                 Football
                                                            </h3>
                                                       </div>
                                                       <div className="col-auto coupon-sale-text offset-lg-4 mr-4 mr-lg-0">
                                                            <h4 className="m-b-2 font1 d-block ls-10 text-white bg-dark">
                                                                 Exclusive COUPON
                                                            </h4>
                                                            <h5 className="mb-0 font1 d-inline-block ls-10 bg-dark">
                                                                 <i className="text-dark ls-0">
                                                                      UP TO
                                                                 </i>
                         ...
                         <section id="cat-6" className="category-section">
                              ...
                              >
                                   <div className="row">
                                        ...
                                        <div className="col-lg-6">
                                             <div
                                                  className="banner banner12"
                                                  style={{ backgroundColor: "#f5a083" }}
                                             >
                                                  <figure>
                                                       <Image
                                                            src={
                                                  ...
                                                  <div className="banner-layer banner-layer-middle">
                                                       <div className="row align-items-center">
                                                            <div className="col-auto">
                                                                 <h2 className="line-height-1 m-b-2">
                                                                      Outlet Selected Items
                                                                 </h2>
                                                                 <h4 className="text-white ls-0 mb-0">
                                                                      <b>BIG SALE UP TO</b>
                                                                 </h4>
                                                            </div>
                                                            ...
                                                            <div className="col-auto">
                                                                 <h3 className="text-white mb-0">
                                                                      80%
                                                                      <small className="d-inline-block text-center">
                                                                           <b>OFF</b>
                                                                      </small>
                                                                 </h3>
                                                            </div>
