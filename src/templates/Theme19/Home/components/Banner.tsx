                    ...
                    <Slider {...settings}>
                         <div className="home-slide home-slide1 banner">
                              <Image
                                   ...
                                   height={400}
                                   className="slide-bg"
                                   src={templateImages.demo19.sliderImage.slide1}
                         ...
                         <div className="home-slide home-slide2 banner">
                              <Image
                                   ...
                                   src={templateImages.demo19.sliderImage.slide2}
                                   style={{ backgroundColor: "#cfcfcf" }}
                                   alt="slider image"
                              />
                              <div className="container d-flex align-items-center">
                                   <div className="banner-layer">
                                        ...
                                        <h5 className="float-right mb-0">
                                             ...
                                             <span
                                                  className="d-inline-block  m-b-1"
                                                  data-animation-name="fadeInUpShorter"
                                                  data-animation-delay="1000"
                                             >
                                                  <b className="coupon-sale-text d-inline-block ls-n-20 text-white bg-secondary">
                                                       <sup>$</sup>199<sup>99</sup>
                                                  </b>
                                             </span>
                                        </h5>
