            ...
            <div className="top-notice bg-dark">
                <div className="container-fluid text-center">
                    <h5 className="text-white ls-0 mb-0">
                        Get 10% extra OFF on Porto Summer Sale - Use <strong>PORTOSUMMER</strong> coupon - <a
                            href="demo19-shop.html">Shop Now!</a>
                    </h5>
                </div>
            </div>
                ...
                <div className="header-middle sticky-header" data-sticky-options="{ 'mobile': true }">
                    <div className="container-fluid">
                        <div className="header-left">
                            ...
                            <a href="demo19.html" className="logo">
                                <Image src={templateImages.logoImage.logo2} alt="Porto Logo" width="111" height="44" />
                            </a>
                        </div>
                        ...
                        <div className="header-right justify-content-end">
                            <nav className="main-nav">
                                <ul className="menu">
                                    ...
                                    <li>
                                        <a className="themeEightDrop" onMouseEnter={() => showDrop("theCategory")} onMouseLeave={() => showDrop("theCategory")} href="demo19-shop.html">Categories</a>
                                        <div style={{ marginLeft: "-50px" }} onMouseEnter={() => showDrop("theCategory")} onMouseLeave={() => showDrop("theCategory")} id="theCategory" className="megamenu megamenu-fixed-width megamenu-3cols">
                                            <div className="row">
                                    ...
                                    <li>
                                        <a className="themeEightDrop" onMouseEnter={() => showDrop("theProducts")} onMouseLeave={() => showDrop("theProducts")} href="demo19-product.html">Products</a>
                                        <div style={{ marginLeft: "-140px" }} onMouseEnter={() => showDrop("theProducts")} onMouseLeave={() => showDrop("theProducts")} id="theProducts" className="megamenu megamenu-fixed-width">
                                            <div className="row">
                                                <div className="col-lg-4">
                                    ...
                                    <li className="d-none d-xl-block">
                                        ...
                                        <ul onMouseEnter={() => showDrop("thePages")} onMouseLeave={() => showDrop("thePages")} id="thePages">
                                            ...
                                            <li><a href="demo19-about.html">About Us</a></li>

                                            <li><a href="demo19-contact.html">Contact Us</a></li>
                            ...
                            <a href="wishlist.html" className="header-icon" title="Wishlist"><i
                                className="icon-wishlist-2"></i><span className="badge-circle">2</span></a>
                                    ...
                                    <div className="dropdownmenu-wrapper custom-scrollbar">
                                        ...
                                        <div className="dropdown-cart-products">
                                            <div className="product">
                                                <div className="product-details">
                                                    <h4 className="product-title">
                                                        <a href="demo19-product.html">Ultimate 3D Bluetooth Speaker</a>
                                                    </h4>
                                                ...
                                                <figure className="product-image-container">
                                                    <a href="demo19-product.html" className="product-image">
                                            ...
                                            <div className="product">
                                                <div className="product-details">
                                                    <h4 className="product-title">
                                                        <a href="demo19-product.html">Brown Women Casual HandBag</a>
                                                    </h4>
                                            ...
                                            <div className="product">
                                                <div className="product-details">
                                                    <h4 className="product-title">
                                                        <a href="demo19-product.html">Circled Ultimate 3D Speaker</a>
                                                    </h4>
