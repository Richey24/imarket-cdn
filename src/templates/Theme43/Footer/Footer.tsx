...
const Footer = () => {
    ...
    return (
        <div>
                ...
                <div>
                    <div>
                        ...
                        <p style={{ width: "350px" }}>
                            ...
                            <span>27 Division St, New York, NY 1002 United States of America</span>
                        </p>
                        <div>
                            <a href="">
            ...
            <div onClick={showOverlay} className="theOverlay" id="theOverlay"></div>
            <div className="theSideOverlay" id="theSideOverlay">
                <Image unoptimized={true} width={100} height={100} src="https://absa7kzimnaf.blob.core.windows.net/templates-images/service/logo.png" alt="" />
                <hr />
                <h1>About Us</h1>
