               ...
               <section className="section-2 banner-section">
                    <div className="banners-grid grid">
                         <div style={{ display: "flex", columnGap: "5px", marginBottom: "5px" }}>
                              <div style={{ width: "80%" }}>
                                   ...
                                   >
                                        <div style={{ width: "57%" }} className="banner banner-1 ">
                                             <figure>
                                                  <Image
                                                       src={
                                                            templateImages.demo12.bannerImage
                                                                 .banner2
                                                       }
                                                       style={{ backgroundColor: "#018cca" }}
                                                       width={200}
                                                       height={200}
                                                       alt="banner"
                                                  />
                                             ...
                                             <div className="banner-layer banner-layer-middle">
                                                  <div className="banner-layer banner-layer-middle">
                                                       <h4 className="text-transform-none text-white">
                                                            Find the Boundaries. Push Through!
                                                       </h4>
                                                       <h2 className="text-transform-none mb-0 text-white">
                                                            Sunglasses
                                                       </h2>
                                        ...
                                        <div style={{ width: "43%" }} className="banner banner-2 ">
                                             ...
                                             <div className="banner-layer banner-layer-middle d-flex align-items-end flex-column">
                                                  ...
                                                  <div className="coupon-sale-content">
                                                       <h4 className="coupon-sale-text bg-white d-block ext-transform-none mr-0 ls-0">
                                                            Exclusive COUPON
                                                       </h4>
                                                       <h5 className="coupon-sale-text text-white ls-0 p-0">
                                                            <i className="ls-0">UP TO</i>
                                                            <b className="text-dark">$100</b>
                                                            <sub>OFF</sub>
                                                       </h5>
                                                       <a
                                                            href="#"
                                                            className="btn btn-block btn-lg ls-10 text-white btn-dark"
                                                       >
                                                            Get Yours!
                                                       </a>
                                                  </div>
                                   ...
                                   <div style={{ width: "100%" }} className="banner banner-4 ">
                                        <figure>
                                             <Image
                                                  src={templateImages.demo12.bannerImage.banner5}
                                                  style={{ backgroundColor: "#fba083" }}
                                                  width={200}
                                                  height={200}
                                                  alt="banner"
                                             />
                              ...
                              <div className="banner banner-3 ">
                                   <figure>
                                        <Image
                                             src={templateImages.demo12.bannerImage.banner4}
                                   ...
                                   <div className="banner-layer banner-layer-bottom d-flex justify-content-center">
                                        <a
                                             href="demo12-shop.html"
                                             className="btn btn-dark ls-10 btn-lg"
                                        >
                                             Shop Now!
                                        </a>
                                   </div>
                         ...
                         <div className="banner banner-5 ">
                              <figure>
                                   <Image
                                        src={templateImages.demo12.bannerImage.banner6}
                                        width={200}
                                        height={200}
                              ...
                              <div className="container">
                                   <div className="row banner-layer-middle align-items-center position-absolute w-100">
                                        ...
                                        <div className="mb-0 col-3 text-center">
                                             <a
                                                  href="#"
                                                  className="btn btn-lg ls-10 text-white btn-dark mb-xl-4 mb-0"
                                             >
                                                  VIEW SALE
                                             </a>
                                        </div>
                                        ...
                                        <div className="col-auto col-4">
                                             <div className="coupon-sale-content d-inline-flex flex-column">
                                                  <h4 className="coupon-sale-text  ext-transform-none mr-0 ls-0 bg-dark text-white ml-0">
                                                       Exclusive COUPON
                                                  </h4>
                                                  <h5 className="coupon-sale-text text-bottom ls-0 mb-0 ml-0">
                                                       <i className="ls-0">UP TO</i>
                                                       <b className="bg-secondary text-white">
                                                            $100
                                                       </b>
                                                       <sub>OFF</sub>
                                                  </h5>
                         ...
                         <div style={{ display: "flex", columnGap: "5px", marginTop: "5px" }}>
                              <div style={{ width: "45%" }} className="banner banner-6 ">
                                   <figure>
                                        <Image
                                             src={templateImages.demo12.bannerImage.banner7}
                                             width={200}
                                             height={200}
                                   ...
                                   <div className="banner-layer banner-layer-middle text-right">
                                        <h2 className="m-b-2 text-secondary ls-n-20 font2">
                                             FLASH SALE
                                        </h2>
                                        <h3 className="m-b-2 ls-n-20">
                                             TOP BRANDS
                                             <br />
                                             SUMMER SUNGLASSES
                                        </h3>
                                        <h4 className="text-white ls-n-20 mb-3 pb-1">
                                             STARTING
                                             <br />
                                             AT <sup>$</sup>199<sup>99</sup>
                                        </h4>
                                        <a href="#" className="btn btn-light ls-10 btn-lg">
                                             VIEW SALE
                                        </a>
                                   </div>
                              </div>
                              ...
                              <div>
                                        ...
                                        <div style={{ width: "45%" }} className="banner banner-7 ">
                                             ...
                                             <div className="banner-layer banner-layer-middle banner-layer-left">
                                                  ...
                                                  <h3 className="text-nowrap">
                                                       MORE THAN
                                                       <span className="d-block">20 BRANDS</span>
                                                  </h3>
                                                  <hr className="mt-0 mb-2" />
                                                  <h5 className="coupon-sale-text ls-10 p-0 mb-0 ml-3 font1 d-inline-flex align-items-center">
                                                       <i className="ls-0">UP TO</i>
                                                       <b className="bg-dark text-white">
                                                            $100
                                                       </b>{" "}
                                                       <span>OFF</span>
                                                  </h5>
                                   ...
                                   <div style={{ display: "flex", columnGap: "5px" }}>
                                        <div
                                             style={{ width: "35%" }}
                                             className=" service-grid-1 service-grid"
                                        >
                                                  ...
                                                  <div className="feature-content m-auto">
                                                       ...
                                                       <div className="feature-box-content p-0">
                                                            ...
                                                            <p>
                                                                 ...
                                                                 nec vestibulum magna, et dapibus
                                                                 lacus.
                                                            </p>
                                                       </div>
                                                  </div>
                                        ...
                                        <div
                                             style={{ width: "35%" }}
                                             className=" service-grid-2 service-grid"
                                        >
                                             <div className="feature-box mb-0 px-xl-5  feature-box-simple text-center d-flex flex-column">
                                                  <div className="feature-content m-auto">
                                        ...
                                        <div
                                             style={{ width: "35%" }}
                                             className=" service-grid-3 service-grid"
                                        >
                                             <div className="feature-box mb-0 px-xl-5 feature-box-simple text-center d-flex flex-column">
                                                  <div className="feature-content m-auto">
