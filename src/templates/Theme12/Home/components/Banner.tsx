     ...
     return (
          <div>
               <section className="section-1 home-section position-relative">
                    <div
                         className="home-banner banner bg-img"
                         style={{
                              backgroundImage: `url(${templateImages.demo12.bannerImage.banner1})`,
                         }}
                    >
                         <div className="banner-layer banner-layer-middle">
                              ...
                              <a href="demo12-shop.html" className="btn btn-dark btn-lg ls-10">
                                   Shop Now!
                              </a>
                         </div>
                    </div>
