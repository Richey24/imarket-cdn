  ...
  return (
    ...
    <div className="container">
         <div className="grid row" style={{position:'relative', height:'485px'}}>
              <div className="grid-item col-lg-8 mb-2" style={{position:'absolute', left:'0%', top:'0px'}} >
                   <div
                        ...
                        <div className="banner-layer banner-layer-middle banner-layer-left">
                             ...
                             >
                                  ...
                                  <h5>
                                       ...
                                       <b className="coupon-sale-text d-inline-block ls-n-20  mb-0" style={{color:'#c90'}}>
              ...
              <div className="grid-item col-lg-4 mb-2" style={{position:'absolute', left:'66.6667%', top:'0px'}} >
              ...
              <div className="grid-item col-lg-4 mb-2" style={{position:'absolute', left:'66.6667%', top:'242px'}}>
                   <div
