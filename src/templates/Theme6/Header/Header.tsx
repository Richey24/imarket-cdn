                         ...
                         <div className="container-fluid">
                              <div className="header-left flex-1 d-none d-xl-flex">
                                   <nav className="main-nav w-100">
                                        <ul className="menu ls-n-10">
                                             <li className="active">
                                                  <a href="demo6.html" className="pl-4">Home</a>
                                             </li>
                                             <li>
                                                  <a className="themeEightDrop" onMouseEnter={() => showDrop("theCategory")} onMouseLeave={() => showDrop("theCategory")} href="demo6-shop.html">Categories</a>
                                             ...
                                             <li>
                                                  <a className="themeEightDrop" onMouseEnter={() => showDrop("theProducts")} onMouseLeave={() => showDrop("theProducts")} href="demo6-product.html">Products</a>
                              ...
                              <div className="header-center ml-0 ml-xl-auto">
                                   <a href="demo6.html" className="logo logo-transition">
                                        <Image src={templateImages.logoImage.logo2} width="113" height="46" alt="Porto" />
                                   </a>
                              </div>
