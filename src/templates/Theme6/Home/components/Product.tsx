          ...
          <div>
               <div className="container-fluid m-b-5 p-b-3">
                    <div className="feature-boxes-container pb-3">
                         <div className="row mt-7 mb-1">
                              <div className="col-xl-3 col-sm-6">
                                   <div
                                        className="feature-box px-sm-5 px-md-5 mx-sm-5 mx-md-3 feature-box-simple feature-rounded text-center">
                              ...
                              <div className="col-xl-3 col-sm-6 " data-animation-name="fadeInRightShorter">
                                   <div
                                        className="feature-box px-sm-5 px-md-5 mx-sm-5 mx-md-3 feature-box-simple feature-rounded text-center">
                              ...
                              <div className="col-xl-3 col-sm-6 " data-animation-name="fadeInLeftShorter">
                                   <div
                                        className="feature-box px-sm-5 px-md-5 mx-sm-5 mx-md-3 feature-box-simple feature-rounded text-center">
                              ...
                              <div className="col-xl-3 col-sm-6 " data-animation-delay="500"
                    ...
                    <div className="products-bottom ">
                         ...
                         <div style={{ display: "flex", gap: "20px" }} className="featured-products nav-outer show-nav-hover">
                              {
                                        ...
                                        <div key={i} className="product-default inner-quickview inner-icon">
                                             <figure>
                                                  <a href="demo6-product.html">
                                                       <Image src={product.productImageUrl} width="400"
                                             ...
                                             <div className="product-details">
                                                  <div className="category-wrap">
                                                       <div className="category-list">
                                                            <a href="demo6-shop.html" className="product-category">{product.productCategory}</a>,
                                                       </div>
                                                       <a href="wishlist.html" title="Wishlist" className="btn-icon-wish"><i
                                                            className="icon-heart"></i></a>
                                                  </div>
                                                  <h3 className="product-title"> <a href="demo6-product.html">{product.productTitle}</a> </h3>
