                ...
                <div className="row grid">
                    <div className="grid-item col-lg-5 height-x1">
                        <div className="home-banner">
                            <figure>
                                <Image src={templateImages.demo29.bannerImage.banner6} width="674"
                            ...
                            <div className="banner-content content-right">
                                ...
                                <a href="demo29-shop.html" className="btn">shop now <i
                    ...
                    <div className="grid-item col-lg-7 height-x2">
                        <div className="home-banner">
                            <figure className="bg-gray">
                                <Image src={templateImages.demo29.bannerImage.banner7} width="951"
                        ...
                        <div className="grid-item col-6 col-lg-2 height-x1">
                            <div className="home-banner">
                                <figure className="bg-dark">
                                    <Image src={templateImages.demo29.bannerImage.banner8} width="257"
                        ...
                        <div className="grid-item col-6 col-lg-3 height-x1">
                            <div className="home-banner">
                                <figure className="bg-primary">
                                    <Image src={templateImages.demo29.bannerImage.banner9} width="396"
                                        height="315" alt="banner" />
                                </figure>
            ...
            <section className="info-box-container mb-0">
                <div className="row">
                    <div className="col-sm-6 col-xl-3 mb-2 mb-xl-0">
                        <div
                            className="info-box info-box-icon-left justify-content-sm-center justify-content-start p-0">
