                         ...
                         <div style={{ display: "flex", gap: "20px" }}>
                              ...
                              >
                                   ...
                                   <div className="product-details">
                                        ...
                                        <h3 className="product-title">
                                             {" "}
                                             <a href="demo10-product.html">Woman Blouse</a>{" "}
                                        </h3>
                              ...
                              >
                                   <figure style={{ height: "533px" }}>
                                        <a href="demo10-product.html">
                                             <Image
                                                  src={templateImages.demo10.grid.gridImage2}
                                                  className="h-100"
                                                  height="490"
                                                  width="366"
                                                  alt="desc"
                                   ...
                                   <div className="product-details">
                                        ...
                                        <h3 className="product-title">
                                             {" "}
                                             <a href="demo10-product.html">Men Cloths</a>{" "}
                                        </h3>
                                        <div className="price-box">
                              ...
                              <div>
                                   <div className="product-default inner-quickview inner-icon inner-icon-inline overlay-dark">
                                        <figure>
                                             <a href="demo10-product.html">
                                                  <Image
                                                       src={templateImages.demo10.grid.gridImage3}
                                                       className="h-100"
                                                       alt="desc"
                                                       width="231"
                                                       height="231"
                                        ...
                                        <div className="product-details">
                                             ...
                                             <h3 className="product-title">
                                                  {" "}
                                                  <a href="demo10-product.html">Man Belt</a>{" "}
                                             </h3>
                                             <div className="price-box">
                                   ...
                                   <div className="product-default inner-quickview inner-icon inner-icon-inline overlay-dark">
                                        <figure>
                                             <a href="demo10-product.html">
                                                  <Image
                                                       src={templateImages.demo10.grid.gridImage4}
                                                       className="h-100"
                                                       alt="desc"
                                                       width="231"
                                                       height="231"
                                        ...
                                        <div className="product-details">
                                             ...
                                             <h3 className="product-title">
                                                  {" "}
                                                  <a href="demo10-product.html">Double Belt</a>{" "}
                                             </h3>
                                             <div className="price-box">
                                                  <span className="product-price">$48.00</span>
                                             </div>
                         ...
                         <div style={{ display: "flex", gap: "20px" }}>
                              <div className="product-default inner-quickview inner-icon inner-icon-inline overlay-dark">
                                   <figure>
                                        <a href="demo10-product.html">
                                             <Image
                                                  src={templateImages.demo10.grid.gridImage5}
                                                  className="h-100"
                                                  alt="desc"
                                                  width="231"
                                                  height="231"
                                   ...
                                   <div className="product-details">
                                        ...
                                        <h3 className="product-title">
                                             {" "}
                                             <a href="demo10-product.html">Woman Bag</a>{" "}
                                        </h3>
                                        <div className="price-box">
                                             <span className="product-price">$48.00</span>
                                        </div>
                              ...
                              <div className="product-default inner-quickview inner-icon inner-icon-inline overlay-dark">
                                   <figure>
                                        <a href="demo10-product.html">
                                             <Image
                                                  src={templateImages.demo10.grid.gridImage6}
                                                  className="h-100"
                                                  alt="desc"
                                                  width="231"
                                                  height="231"
                                   ...
                                   <div className="product-details">
                                        ...
                                        <h3 className="product-title">
                                             {" "}
                                             <a href="demo10-product.html">Man Shoes</a>{" "}
                                        </h3>
                                        <div className="price-box">
