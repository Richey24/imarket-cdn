                    ...
                    <div style={{ display: "flex", gap: "20px", flexWrap: "wrap" }}>
                        {
                            featuredProducts.slice(0, 5).map((product, i) => (
                                <div style={{ width: "190px" }} key={i} className="product-default inner-quickview inner-icon">
                                    <figure>
                                    ...
                                    <div className="product-details">
                                        ...
                                        <h3 className="product-title"> <a href="demo10-product.html">{product.productTitle}</a>
                                        </h3>
                ...
                <div className="newsletter-section bg-img">
                    <div className="banner">
                        ...
                        <div className="banner-layer banner-layer-middle text-right">
                            ...
                            <h3>
                                <b className="text-white position-relative">BIG SALE</b> ALL NEW FASHION BRANDS ITEMS UP TO
                                70% OFF
                            </h3>
                            <a href="demo10-shop.html" className="btn btn-xl" role="button">Shop Now<i
