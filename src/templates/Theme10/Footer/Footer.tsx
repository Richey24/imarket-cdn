            ...
            <footer className="footer">
                                ...
                                <div className="widget">
                                    ...
                                    <div className="social-icons mb-6 mb-md-0">
                                        ...
                                        <a href="#" className="social-icon social-twitter icon-twitter" target="_blank"
                                            title="Twitter"></a>
                                        <a href="#" className="social-icon social-linkedin icon-instagram" target="_blank"
                                            title="Linkedin"></a>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="container">
                    <div className="footer-bottom d-flex justify-content-between align-items-center flex-wrap">
                        <p className="footer-copyright py-3 pr-sm-4 pr-0 mb-0">© Dreamtechlabs 2021. All Rights Reserved.
                        </p>
                    </div>
                </div>
            </footer>
