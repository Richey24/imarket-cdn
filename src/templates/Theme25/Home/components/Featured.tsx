                         ...
                         <div className="row">
                              <div className="col-lg-4 m-b-3">
                                   <div
                                        ...
                                        style={{
                                             ...
                                             backgroundImage: `url(${templateImages.demo25.bannerImage.banner3})`,
                                        }}
                                        data-animation-name="fadeInRightShorter"
                                        data-animation-delay="200"
                                   >
                                        <div className="banner-layer">
                                             <h3 className="text-uppercase text-white m-b-2">
                                                  Award Winners
                                             </h3>
                                             <p className="font2 m-b-3">12 Books</p>
                                             <a href="demo25-shop.html" className="btn btn-primary">
                                                  View Collections
                              ...
                              <div className="col-lg-4 m-b-3">
                                   <div
                                        ...
                                        style={{
                                             ...
                                             backgroundImage: `url(${templateImages.demo25.bannerImage.banner4})`,
                                        }}
                                        data-animation-name="fadeInRightShorter"
                              ...
                              <div className="col-lg-4 m-b-5">
                                   <div
                                        ...
                                        style={{
                                             backgroundColor: "#343436",
                                             backgroundImage: `url(${templateImages.demo25.bannerImage.banner5})`,
                                        }}
                                        data-animation-name="fadeInRightShorter"
