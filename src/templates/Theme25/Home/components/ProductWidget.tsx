...
const ProductWidget = ({ quickView }) => {
     ...
     return (
          <div>
               <div id="quickViewDiv" style={{ position: "fixed", top: "1%", left: "20%", zIndex: "9", height: "580px", display: "none" }} className="product-single-container product-single-default product-quick-view mb-0 custom-scrollbar">
                    <div className="row">
                         <div className="col-md-6 product-single-gallery mb-md-0">
                              ...
                              <div className="prod-thumbnail owl-dots">
                                   <div className="owl-dot">
                                        <Image style={{ height: "90px" }} width={200} height={200} alt="product" src={quickView.productImageUrl} />
                                   </div>
                                   <div className="owl-dot">
                         ...
                         <div className="col-md-6">
                              <div className="product-single-details mb-0 ml-md-4">
                                   ...
                                   <div className="price-box">
                                        <span className="product-price"> ${quickView.productPrice}.00</span>
                                   </div>
                                   ...
                                   <ul className="single-info-list">
                                        ...
                                        <li>
                                             CATEGORY:
                                             <strong>
                                                  <a href="#" className="product-category">{quickView.productCategory}</a>
                                             </strong>
                                        </li>
                                   </ul>

                                   <div className="product-filters-container">
                                        <div style={{ alignItems: "baseline", display: "block" }} className="product-single-filter">
                                             <label>Size:</label>
                                             <ul className="config-size-list">
                                                  <li><a href="javascript:;" onClick={() => setSelected("XL")} style={selected === "XL" ? { backgroundColor: "#FF7272", color: "white" } : {}} className="d-flex align-items-center justify-content-center">XL</a>
                                                  </li>
                                                  <li className=""><a onClick={() => setSelected("L")} style={selected === "L" ? { backgroundColor: "#FF7272", color: "white" } : {}} href="javascript:;"
                                                       className="d-flex align-items-center justify-content-center">L</a></li>
                                                  <li className=""><a onClick={() => setSelected("M")} style={selected === "M" ? { backgroundColor: "#FF7272", color: "white" } : {}} href="javascript:;"
                                                       className="d-flex align-items-center justify-content-center">M</a></li>
                                                  <li className=""><a onClick={() => setSelected("S")} style={selected === "S" ? { backgroundColor: "#FF7272", color: "white" } : {}} href="javascript:;"
                                                       className="d-flex align-items-center justify-content-center">S</a></li>
                                             </ul>
                                        </div>

                                        {selected !== "" && <div style={{ display: "block" }} className="product-single-filter">
                                             <label></label>
                                             <a style={{ color: "white", backgroundColor: "#FF7272", cursor: "pointer" }} onClick={() => setSelected("")} className="font1 text-uppercase clear-btn">Clear</a>
                                        </div>}
                                   </div>

                                   <div style={{ display: "flex", columnGap: "95px", alignItems: "baseline" }} className="product-action">
                                        ...
                                        <div style={{ display: "flex", flexWrap: "nowrap", alignItems: "baseline" }} className="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                             ...
                                             <input onChange={(e) => setQty(Number(e.target.value))} value={qty} style={{ paddingTop: "13px", paddingBottom: "14px", paddingLeft: "14px", width: "40px", borderTop: "0.5px solid #6F7174", borderBottom: "0.5px solid #6F7174", outline: "none" }} type="text" />
                                        ...
                                        <a style={{ height: "49px", backgroundColor: "#6F7174", border: "none", outline: "none" }} href="javascript:;" className="btn btn-dark add-cart mr-2" title="Add to Cart">Add to Cart</a>
                                   ...
                                   <div className="product-single-share mb-0">
                                        ...
                                        <div className="social-icons mr-2">
                                             ...
                                             <a href="#" className="social-icon social-linkedin fab fa-linkedin-in" target="_blank"
                                                  title="Linkedin"></a>
                                             <a href="#" className="social-icon social-gplus fab fa-google-plus-g" target="_blank"
                                                  title="Google +"></a>
                         ...
                         <button onClick={hideView} title="Close (Esc)" type="button" className="mfp-close">
                              ×
                         </button>
                    </div>
               </div>
