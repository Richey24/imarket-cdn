                         ...
                         <Slider {...settings}>
                              <div className="theBanner25">
                                   <div className="home-slide">
                                        <a href="demo25-shop.html">
                                             <Image
                                                  src={templateImages.demo25.sliderImage.slide1}
                                                  alt="slider"
                                                  width="545"
                                                  height="398"
                                             />
                                        ...
                                        <div className="product-default">
                                             <figure>
                                                  <Image
                                                       src={
                                                            templateImages.demo25.productImages
                                                                 .product1
                                                       }
                                                       alt="product"
                                                       width="250"
                                   ...
                                   <div className="home-slide">
                                        <a href="demo25-shop.html">
                                             <Image
                                                  src={templateImages.demo25.sliderImage.slide2}
                                                  alt="slider"
                                                  width="545"
                                                  height="398"
                                             />
                                   ...
                                   <div className="home-slide">
                                        <a href="demo25-shop.html">
                                             <Image
                                                  src={templateImages.demo25.sliderImage.slide3}
                                                  alt="slider"
                                                  width="545"
                                                  height="398"
                                             />
                              ...
                              <div className="theBanner25">
                                   <div className="home-slide">
                                        <a href="demo25-shop.html">
                                             <Image
                                                  src={templateImages.demo25.sliderImage.slide4}
                                                  alt="slider"
                                                  width="545"
                                                  height="398"
                                             />
                                   ...
                                   <div className="home-slide">
                                        <a href="demo25-shop.html">
                                             <Image
                                                  src={templateImages.demo25.sliderImage.slide5}
                                                  alt="slider"
                                                  width="545"
                                                  height="398"
                                             />
