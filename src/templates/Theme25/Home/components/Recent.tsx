...
const Recent = ({ setQuickView }) => {
    ...
    return (
        <div>
            <section className="promo-section bg-primary"
                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-7 col-lg-3" data-animation-name="fadeInLeftShorter"
                            data-animation-delay="500">
                            <a href="demo25-shop.html" className="btn btn-quaternary">Explore Books <i
                                    ...
                                    <div className="product-default inner-quickview inner-icon">
                                        ...
                                        <div className="product-details">
                                            ...
                                            <div className="price-box">
                                                <span className="product-price">$2{product.productPrice}.0</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
