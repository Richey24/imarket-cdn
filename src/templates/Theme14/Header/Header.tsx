               ...
               >
                    <div className="container">
                         ...
                         <div className="header-center order-first order-lg-0 ml-0 ml-lg-auto">
                              ...
                              <a href="demo14.html" className="logo">
                                   <img src={logo.src} alt="Porto Logo" width={202} height={80} />
                              </a>
                         </div>
                         {/* End .header-center */}
                         <div className="header-right w-lg-max ml-0 ml-lg-auto">
                              <div className="header-contact d-none d-lg-flex align-items-center ml-auto mr-4">
                                   ...
                                   <h6 className="line-height-1 pr-2">
                                        Call us now
                                        <a href="tel:#" className="d-block text-dark font1">
                                             +123 5678 890
                                        </a>
                                   </h6>
                              </div>
                                             ...
                                             <div className="dropdown-cart-products">
                                                  <div className="product">
                                                       ...
                                                       <figure className="product-image-container">
                                                            ...
                                                            >
                                                                 <img
                                                                      src="assets/images/demoes/demo14/products/small/1.jpg"
                                                                      alt="product"
                                                                      width={80}
                                                                      height={80}
                                                                 />
                                                  ...
                                                  <div className="product">
                                                       ...
                                                       <figure className="product-image-container">
                                                            ...
                                                            >
                                                                 <img
                                                                      src="assets/images/demoes/demo14/products/small/2.jpg"
                                                                      alt="product"
                                                                      width={80}
                                                                      height={80}
                                                                 />
                                                  ...
                                                  <div className="product">
                                                       ...
                                                       <figure className="product-image-container">
                                                            ...
                                                            >
                                                                 <img
                                                                      src="assets/images/demoes/demo14/products/small/3.jpg"
                                                                      alt="product"
                                                                      width={80}
                                                                      height={80}
                                                                 />
               ...
               >
                    <div className="container">
                                   ...
                                   >
                                        ...
                                        {pag && (
                                             ...
                                             >
                                                  ...
                                                  <li>
                                                       <a href="demo21-contact.html">Contact Us</a>
                                                  </li>
                                                  <li>
                         ...
                         <div className="header-right">
                              ...
                              {/* End .header-search */}
                              <a href="login.html" className="header-icon account-icon">
                                   <i className="icon-user-2" />
                              </a>
