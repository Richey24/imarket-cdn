                                    ...
                                    <div className="col-sm-4">
                                        <div className="widget">
                                            ...
                                            <ul className="contact-info mb-3">
                                                <li>
                                                    <span className="contact-info-label">Phone:</span>Toll Free <a
                                                        href="tel:">(123)
                                                        456-7890</a>
                                                </li>
                                                <li>
                                            ...
                                            <div className="social-icons">
                                                <a href="#" className="social-icon social-facebook icon-facebook"></a>
                                                <a href="#" className="social-icon social-twitter icon-twitter"></a>
                                                <a href="#" className="social-icon social-linkedin fab fa-linkedin-in"></a>
                                            </div>
