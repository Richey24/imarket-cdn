    ...
    return (
        <div>
            <header className="header">
                    ...
                    <div className="header-row container">
                        ...
                        <div className="header-right">
                            ...
                            <div className="share-links d-none d-xl-block">
                                <a target="_blank" rel="nofollow" className="share-facebook icon-facebook" href="#"
                                    title="Facebook"></a>
                                <a target="_blank" rel="nofollow" className="share-twitter icon-twitter" href="#"
                                    title="Twitter"></a>
                                <a target="_blank" rel="nofollow" className="share-instagram icon-instagram" href="#"
                                    title="Instagram"></a>
                            </div>
                        </div>
                    </div>
                ...
                <div style={{ padding: "0px" }} className="header-middle sticky-header" data-sticky-options="{'mobile': true}">
                    <div className="container">
                        ...
                        <div className="header-center">
                            ...
                            <a href="demo8.html" className="logo">
                                <Image src={logo} alt="Porto Logo" width="104" height="41" />
                            </a>
                        </div>
                        ...
                        <div style={{ alignItems: "baseline" }} className="header-right">
                            ...
                            <a href="#" className="header-icon"><i className="icon-wishlist-2"></i></a>
                            <div className="header-search header-search-popup header-search-category d-none d-sm-block">
                                <a onClick={showSearch} className="search-toggle" role="button"><i className="icon-magnifier"></i></a>
                                <form action="#" method="get">
                                    <div id="searchDiv" style={{ borderRadius: "30px" }} className="header-search-wrapper">
                                        <input style={{ borderRadius: "30px" }} type="search" className="form-control" name="q" id="q"
                                        ...
                                        <button style={{ borderRadius: "30px" }} className="btn icon-search-3" type="submit"></button>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div className="dropdown cart-dropdown">
                                ...
                                <div id="cartCanvas" className="cartCanvas" style={{ position: "fixed", top: "0px", right: "0px", zIndex: "10", alignItems: "flex-start", gap: "10px" }} >
                                    <a onClick={showCanvas} style={{ fontSize: "40px", color: "white" }} href="#" title="Close (Esc)" className="btn-close">×</a>
                                        ...
                                        <div className="dropdown-cart-products">
                                            <div className="product">
                                                ...
                                                <figure className="product-image-container">
                                                    <a href="demo8-product.html" className="product-image">
                                                        <Image src={logo} alt="product" width="80"
                                                            height="80" />
                                                    </a>
                    ...
                    <div className="container">
                        <nav className="main-nav w-100">
                            <ul className="menu w-100">
                                ...
                                <li>
                                    <a onMouseEnter={() => showDrop("theCategory")} onMouseLeave={() => showDrop("theCategory")} className="themeEightDrop" href="demo8-shop.html">Categories</a>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-4 p-0">
                                                <div className="menu-banner">
                                                    <figure>
                                                        <Image src={menuBanner} width="192" height="313"
                                                            alt="Menu banner" />
                                                    </figure>
                                ...
                                <li>
                                    <a onMouseEnter={() => showDrop("theProducts")} onMouseLeave={() => showDrop("theProducts")} className="themeEightDrop" href="demo8-product.html">Products</a>
                                ...
                                <li>
                                    <a onMouseEnter={() => showDrop("thePages")} onMouseLeave={() => showDrop("thePages")} className="themeEightDrop" href="#">Pages</a>
                                ...
                                <li style={{ display: "block" }}><a href="demo8-contact.html">Contact Us</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
