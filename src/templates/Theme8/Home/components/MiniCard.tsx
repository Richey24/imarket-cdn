    ...
    return (
        <div>
            <div className="container">
                <div className="product-widgets row pt-1">
                    <div className="col-md-4 col-sm-6 pb-5">
                        <h4 style={{ fontSize: "15px" }} className="subtitle text-left text-uppercase">Top Rated Products</h4>
                        <div className="heading-spacer"></div>
                        {
                            featuredProduct.slice(0, 3).map((product, i) => (
                                <div key={i} className="product-default left-details product-widget mb-2">
                                    <figure>
                                        <a href="demo8-product.html">
                                            <Image src={product.productImageUrl} width="175"
                                                height="175" alt="product" />
                                            <Image src={product1} width="175"
                                                height="175" alt="product" />
                                        </a>
                                    </figure>
                                    <div className="product-details">
                                        ...
                                        <h3 className="product-title"> <a href="demo8-product.html">{product.productTitle}</a> </h3>
                    ...
                    <div className="col-md-4 col-sm-6 pb-5">
                        <h4 style={{ fontSize: "15px" }} className="subtitle text-left text-uppercase">Best Selling Products</h4>
                        <div className="heading-spacer"></div>
                        {
                    ...
                    <div className="col-md-4 col-sm-6 pb-5">
                        <h4 style={{ fontSize: "15px" }} className="subtitle text-left text-uppercase">Latest Products</h4>
                        <div className="heading-spacer"></div>
                        {
                            latestProducts.slice(0, 3).map((product, i) => (
                                <div key={i} className="product-default left-details product-widget mb-2">
                                    <figure>
                                        <a href="demo8-product.html">
                                            <Image src={product.productImageUrl} width="175"
                                                height="175" alt="banner" />
                                            <Image src={product5} width="175"
                                                height="175" alt="product" />
                                        </a>
                                    </figure>
                                    <div className="product-details">
            ...
            <div className="instagram-section">
                ...
                <div className="heading-spacer"></div>
                <div style={{ display: "flex" }} className="instagram-feed-carousel instagram-feed-list">
                    <a href="#"><Image src={instagram1} width="197" height="150"
                        alt="Feed" /></a>
                    <a href="#"><Image src={instagram2} width="197" height="150"
                        alt="Feed" /></a>
                    <a href="#"><Image src={instagram3} width="197" height="150"
                        alt="Feed" /></a>
                    <a href="#"><Image src={instagram4} width="197" height="150"
                        alt="Feed" /></a>
                    <a href="#"><Image src={instagram5} width="197" height="150"
                        alt="Feed" /></a>
                    <a href="#"><Image src={instagram6} width="197" height="150"
                        alt="Feed" /></a>
                    <a href="#"><Image src={instagram7} width="197" height="150"
                        alt="Feed" /></a>
                    <a href="#"><Image src={instagram8} width="197" height="150"
                        alt="Feed" /></a>
                    <a href="#"><Image src={instagram9} width="197" height="150"
                        alt="Feed" /></a>
                    <a href="#"><Image src={instagram10} width="197" height="150"
                        alt="Feed" /></a>
                </div>
            </div>
        </div>
