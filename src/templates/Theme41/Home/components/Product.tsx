          ...
          <div>
               <section className="product-section container">
                    <div className="product-slider-tab">
                         <span
                              className="inline-title d-sm-inline-block "
                         ...
                         <ul
                              className="nav nav-tabs d-sm-inline-flex mt-1 "
                              data-animation-delay="300"
                         >
                              <li onClick={() => setActive("new")} className="nav-item">
                                   <a
                                        className={
                                             active === "new" ? "nav-link active show" : "nav-link"
                                        }
                                        id="new-products-tab"
                                        data-toggle="tab"
                              ...
                              <li onClick={() => setActive("best")} className="nav-item">
                                   <a
                                        className={
                                             active === "best" ? "nav-link active show" : "nav-link"
                                        }
                              ...
                              <li onClick={() => setActive("sale")} className="nav-item">
                                   <a
                                        className={
                                             active === "sale" ? "nav-link active show" : "nav-link"
                                        }
                    ...
                    <div className="product-banner banner">
                         <div className="row justify-content-center mx-0">
                              <div className="col-lg-4 py-6 banner-content">
                                   <h4
                                        className="banner-subtitle font-weight-normal text-right "
                              ...
                              <div className="col-lg-4">
                                   <Image
                                        src={templateImages.demo41.bannerImage.banner4}
                              ...
                              <div className="col-lg-4 py-6 banner-price" style={{ zIndex: "1" }}>
                                   <h2
                                        className="up-to text-right mb-0 pb-2 "
                                        data-animation-name="fadeInLeftShorter"
                                        data-animation-delay="200"
                                   >
                                        <sup className="font-weight-bold">ONLY</sup>
                                        <strong>$0,99</strong>
                                   </h2>
                              </div>
                         </div>
                    ...
                    <div style={{ display: "flex", gap: "20px" }}>
                         <div className="product-category content-left-center">
                              <a href="demo41-shop.html">
                                   <figure>
                                        <Image
                                             src={templateImages.demo41.categoryImage.category1}
                                             width="393"
                                             height="200"
                                             alt="category"
                                        />
                         ...
                         <div className="product-category content-left-center">
                              <a href="demo41-shop.html">
                                   <figure>
                                        <Image
                                             src={templateImages.demo41.categoryImage.category2}
                                             width="393"
                                             height="200"
                                             alt="category"
                                        />
                                   ...
                                   <div className="category-content">
                                        <h3>Fruits</h3>
                                        <span>
                                             <mark className="count">10</mark> Products
                                        </span>
                                   </div>
                              </a>
                         </div>
                         <div className="product-category content-left-center">
                              <a href="demo41-shop.html">
                                   <figure>
                                        <Image
                                             src={templateImages.demo41.categoryImage.category3}
                                             width="393"
                                             height="200"
                                             alt="category"
                                        />
                                   ...
                                   <div className="category-content">
                                        <h3>Meat</h3>
                                        <span>
                                             <mark className="count">6</mark> Products
                                        </span>
                                   </div>
                              </a>
                         </div>
