                              ...
                              <div className="row">
                                   <div className="col-lg-6 order-1">
                                        <div className="banner-layer banner-layer-middle position-relative">
                                             <h5
                                                  className="banner-subtitle font-weight-normal "
                                             ...
                                             <h3
                                                  className="banner-desc text-uppercase "
                                                  data-animation-name="fadeInUpShorter"
                                             ...
                                             <h4
                                                  className="custom-text-1 text-secondary "
                                             ...
                                             >
                                                  <sup className="font-weight-bold">UP TO</sup>
                                                  <strong>
                                                       50%<small>OFF</small>
                                                  </strong>
                                             </h2>
                                   ...
                                   <div className="col-lg-6 order-0 order-lg-1">
                                        <figure className="banner-media">
                                             <Image
                                                  src={templateImages.demo41.bannerImage.banner2}
                              ...
                              <div className="row">
                                   <div className="col-lg-6">
                                        <figure className="banner-media position-relative">
                                             <Image
                                                  src={templateImages.demo41.bannerImage.banner3}
                                                  data-plugin-float-element
                                                  data-plugin-options="{'startPos': 'top', 'speed': 9.8, 'transition': true, 'horizontal':false,'transitionDuration':1000}"
                                                  width="497"
                                                  height="473"
