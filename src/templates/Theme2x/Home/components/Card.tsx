...
const Card = () => {
    return (
        <div style={{ paddingLeft: "100px", paddingRight: "100px", paddingBottom: "20px" }}>
            <div className="info-boxes-container row row-joined mb-1 appear-animate"
            ...
            <div className="banners-grid text-uppercase grid" data-grid-options="{
					'sortReorder': true
				}" style={{ position: "relative", height: "1120px" }}>
                <div className="banner banner1 grid-item banner-md-vw w-25 w-md-100 text-transform-none w-xxs-100 appear-animate"
                    data-animation-name="fadeInUpShorter" data-animation-delay="100" data-animation-duration="1000"
                    data-md-order="1" style={{ position: "absolute", left: "0%", top: "0px" }}>
                    <figure>
                        <Image width={200} height={200} src={banner1} style={{ backgroundColor: "#ccc" }}
                            alt="banner" />
                    </figure>
                ...
                <div className="banner banner7 grid-item banner-md-vw w-50 w-md-100 order-lg-0 w-xxs-100 appear-animate"
                    data-animation-name="fadeInUpShorter" data-animation-delay="200" data-animation-duration="1000"
                    data-md-order="3" style={{ position: "absolute", left: "25%", top: "0px" }}>
                    <figure>
                        <Image width={200} height={200} src={banner7} style={{ backgroundColor: "#444" }}
                            alt="banner" />
                    </figure>
                    ...
                    <div className="banner-layer banner-layer-middle d-flex align-items-end flex-column">
                        ...
                        <div className="coupon-sale-content">
                            ...
                            <a href="demo2-shop.html" className="btn btn-block btn-dark btn-black">Get Yours!</a>
                        </div>
                    </div>
                </div>

                <div className="banner banner4 grid-item banner-md-vw w-25 w-md-100 w-xxs-100 appear-animate"
                    data-animation-name="fadeInUpShorter" data-animation-delay="300" data-animation-duration="1000"
                    data-md-order="7" style={{ position: "absolute", left: "75%", top: "0px" }}>
                    <figure>
                        <Image width={200} height={200} src={banner4} style={{ backgroundColor: "#444" }}
                            alt="banner" />
                    </figure>
                    <div className="banner-layer banner-layer-middle text-right">
                        ...
                        <a href="demo2-shop.html" className="btn btn-light ls-10">View Sale</a>
                    </div>
                </div>


                <div className="banner banner4 grid-item banner-md-vw text-center w-25 w-md-100 w-xxs-100 appear-animate"
                    data-animation-name="fadeInUpShorter" data-animation-delay="400" data-animation-duration="1000"
                    data-md-order="8" style={{ position: "absolute", left: "75%", top: "245px" }}>
                    <figure>
                        <Image width={200} height={200} src={banner5} style={{ backgroundColor: "#ccc", }}
                            alt="banner" />
                    </figure>
                    ...
                    <div className="banner-layer banner-layer-bottom">
                        <a href="demo2-shop.html" className="btn btn-dark">Shop Now!</a>
                    </div>
                </div>


                <div className="banner banner2 grid-item banner-md-vw w-25 w-md-100 w-xxs-100 appear-animate"
                    data-animation-name="fadeInUpShorter" data-animation-delay="500" data-animation-duration="1000"
                    data-md-order="2" style={{ position: "absolute", left: "0%", top: "320px" }}>
                    <figure>
                        <Image width={200} height={200} src={banner2}
                            style={{ backgroundColor: "#dce1e7" }} alt="banner" />
                    </figure>
                    <div className="banner-layer banner-layer-top text-right">
                        ...
                        <a href="demo2-shop.html" className="btn btn-dark ls-10">Buy Now!</a>
                    </div>
                </div>


                <div className="banner banner8 grid-item banner-md-vw w-50 w-md-100 w-xxs-100 appear-animate"
                    data-animation-name="fadeInUpShorter" data-animation-delay="600" data-animation-duration="1000"
                    data-md-order="4" style={{ position: "absolute", left: "25%", top: "380px" }}>
                    <figure>
                        <Image width={200} height={200} src={banner8}
                            style={{ backgroundColor: "#bd9c88" }} alt="banner" />
                    </figure>
                    <div className="banner-layer banner-layer-middle">
                        <h3 className="m-b-2 text-transform-none">Exclusive Shoes</h3>
                        <h4 className="m-b-3">50% Off</h4>
                        <a href="demo2-shop.html" className="btn btn-dark ls-10">Get Yours!</a>
                    </div>
                </div>


                <div className="banner banner9 grid-item banner-md-vw text-center w-50 w-md-100 w-xxs-100 appear-animate"
                    data-animation-name="fadeInUpShorter" data-animation-delay="700" data-animation-duration="1000"
                    data-md-order="5" style={{ position: "absolute", left: "25.5%", top: "640px" }}>
                    <figure>
                        <Image width={200} height={200} src={banner9} style={{ backgroundColor: "#fff" }}
                            alt="banner" />
                    </figure>
                ...
                <div className="banner banner3 grid-item banner-md-vw w-25 w-md-100 w-xxs-100 appear-animate"
                    data-animation-name="fadeInUpShorter" data-animation-delay="800" data-animation-duration="1000"
                    data-md-order="9" style={{ position: "absolute", left: "0%", top: "680px" }}>
                    <figure>
                        <Image width={200} height={200} src={banner3} style={{ backgroundColor: "#ccc" }}
                            alt="banner" />
                    </figure>
                ...
                <div className="banner banner6 grid-item banner-md-vw w-25 w-md-100 w-xxs-100 appear-animate"
                    data-animation-name="fadeInUpShorter" data-animation-delay="900" data-animation-duration="1000"
                    data-md-order="6" style={{ position: "absolute", left: "75%", top: "750px" }}>
                    <figure>
                        <Image width={200} height={200} src={banner6} style={{ backgroundColor: "#ccc" }}
                            alt="banner" />
                    </figure>
