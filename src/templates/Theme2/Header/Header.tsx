               ...
               <div className="container">
                    <div className="header-top d-flex align-items-center w-100">
                         <div className="header-left">
                              <p className="top-message ls-0 text-uppercase text-white d-none d-sm-block">FREE Returns. Standard
               ...
               <div className="header-middle sticky-header" data-sticky-options="{'mobile': true}">
                    <div className="container">
                         ...
                         <div className="header-right w-lg-max ml-0">
                              <div
                                   className="header-icon mb-0 header-search header-search-inline header-search-category w-lg-max pl-3 pr-1">
                                   <a href="#" className="search-toggle" role="button" title="Search"><i
                                        className="icon-search-3"></i></a>
                                   <form action="#" method="get">
                                        <div className="header-search-wrapper">
                                             <input type="search" className="form-control bg-white" name="q" id="qq"
                                             ...
                                             <button className="btn icon-magnifier pb-1 bg-white" type="submit"
                                                  title="Search"></button>
                                        </div>
                                   </form>
                              </div>
                              ...
                              <div className="header-contact d-none d-lg-flex pl-4 ml-3 mr-xl-5">
                                   <Image alt="phone" src={phone} width="30" height="30" className="pb-1" />
                                   <h6>Call us now<a href="tel:#" className="font1">+123 5678 890</a></h6>
                              </div>

                              <a href="login.html" className="header-icon d-inline-block" title="Login"><i
                                   className="icon-user-2"></i></a>

                              <a href="wishlist.html" className="header-icon d-inline-block" title="Wishlist"><i
                                             ...
                                             <div className="dropdown-cart-products">
                                                  <div className="product">
                                                       ...
                                                       <figure className="product-image-container">
                                                            <a href="demo2-product.html" className="product-image">
                                                       ...
                                                       <div className="col-lg-4 p-0">
                                                            <div className="menu-banner">
                                                                 ...
                                                                 <div className="banner-content">
                                                                      ...
                                                                      <a href="demo2-shop.html" className="btn btn-sm btn-dark">SHOP
                                                                           NOW</a>
                                                                 </div>
                                                            </div>
                                                       </div>
                                                  ...
                                                  <div className="row">
                                                       ...
                                                       <div className="col-lg-4 p-0">
                                                            <div className="menu-banner menu-banner-2">
                                                                 ...
                                                                 <a href="demo2-shop.html" className="btn btn-sm btn-dark">SHOP NOW</a>
                                                            </div>
                                                       </div>
