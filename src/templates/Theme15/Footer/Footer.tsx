const Footer = () => {
     return (
          <footer className="footer bg-dark appear-animate">
              ...
              <div>
                <div className="widget">
                  ...
                  <ul className="contact-info d-flex flex-wrap">
                    <li>
                      <span className="contact-info-label">Address:</span>1234
            ...
            <div className="col-lg-3">
              <div className="widget widget-product mb-3">
                ...
                <div className="product-default left-details product-widget">
                  <figure>
                    <a href="demo15-product.html">
                      <img
                        src="assets/images/demoes/demo15/products/product-9.jpg"
                        width={95}
                        height={95}
                        alt="product"
                      />
                  ...
                  <div className="product-details">
                    <h3 className="product-title text-white">
                      <a href="demo15-product.html">Woman Black Blouse</a>
                    </h3>
                ...
                <div className="product-default left-details product-widget">
                  ...
                  <div className="product-details">
                    <h3 className="product-title text-white">
                      <a href="demo15-product.html">Porto Sticky Info</a>
                    </h3>
                    {/* <div class="ratings-container">
                              <div class="product-ratings">
                                  <span class="ratings" style="width:100%"></span>
