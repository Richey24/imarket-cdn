    ...
    return <div className="categories-section bg-primary">
        <div className="container">
            ...
            <OwlCarousel className="owl-carousel owl-theme show-nav-hover" {...owlCarouselOptions}>
                ...
                <div className="banner banner-image">
                    <Link href="demo7-product.html">
                        <Image src="https://images.unsplash.com/photo-1414322058660-a4c56ab6c1e2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80" width="272" height="231"
                            alt="banner" />
                    </Link>
                    <div className="banner-layer banner-layer-middle">
                        <h3>TOYS</h3>
                ...
                <div className="banner banner-image">
                    <Link href="demo7-shop.html">
                        <Image src="https://images.unsplash.com/photo-1501004318641-b39e6451bec6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1073&q=80" width="272" height="231"
                            alt="banner" />
                    </Link>
                    <div className="banner-layer banner-layer-middle">
                        <h3>Dress</h3>
